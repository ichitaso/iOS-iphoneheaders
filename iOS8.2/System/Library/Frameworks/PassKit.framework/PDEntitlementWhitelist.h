...
@property (readonly) char paymentPassAccess;                          //@synthesize paymentPassAccess=_paymentPassAccess - In the implementation block

...
@interface UIViewController : UIResponder <_UIViewServiceDeputy, NSExtensionRequestHandling, UIViewControllerPresenting, _UITraitEnvironmentInternal, _UIContentContainerInternal, NSCoding, UIAppearanceContainer, UITraitEnvironment, UIContentContainer, GKContentRefresh, GKURLHandling> {
	...
	SCD_Struct_UI26 _presentationSizeClassPair;
...
@property (assign,setter=_setPresentationSizeClassPair:,getter=_presentationSizeClassPair,nonatomic) SCD_Struct_UI26 presentationSizeClassPair;                                                    //@synthesize presentationSizeClassPair=_presentationSizeClassPair - In the implementation block
...
-(char)_isPresentedDescendantOfViewController:(id)arg1 ;
...
-(void)_setPresentationSizeClassPair:(SCD_Struct_UI26)arg1 ;

...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI15)arg1 inRect:(CGRect)arg2 fraction:(float)arg3 ;
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI15)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(float)arg4 ;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI15)arg1 inRect:(CGRect)arg2 ;

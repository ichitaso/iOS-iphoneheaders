...
-(void)_wrappedProcessTraitsDidChangeRecursively:(id)arg1 forceNotification:(char)arg2 ;
...
-(void)_notifyGeometryObserversOfOriginChange:(char)arg1 sizeChanged:(char)arg2 ;
...
-(void)_processTraitsDidChangeRecursively:(id)arg1 forceNotification:(char)arg2 ;

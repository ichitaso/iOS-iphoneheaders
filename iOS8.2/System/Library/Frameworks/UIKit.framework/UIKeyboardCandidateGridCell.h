...
+(id)reuseIdentifier;
+(CGColorRef)legacy_outlineColorForVisualStyling:(SCD_Struct_UI31)arg1 candidatesVisualStyle:(int)arg2 ;
+(CGColorRef)legacy_outlineShadowColorForVisualStyling:(SCD_Struct_UI31)arg1 candidatesVisualStyle:(int)arg2 ;

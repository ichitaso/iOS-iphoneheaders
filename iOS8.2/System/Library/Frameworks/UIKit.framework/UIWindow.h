...
@class UIView, UIResponder, NSUndoManager, UIScreen, CALayer, NSMutableArray, UIViewController, UIColor, NSMutableSet, NSString, FBSScene, _UIResponderSelectionCursor, _UISystemGestureGateGestureRecognizer, UITraitCollection, _UIViewControllerNullAnimationTransitionCoordinator, NSArray, _UIWindowAnimationController, _UISimulatedApplicationResizeGestureRecognizerDelegate;
...
@property (setter=_setSimulatedApplicationResizeGestureRecognizerDelegate:,nonatomic,retain) _UISimulatedApplicationResizeGestureRecognizerDelegate * _simulatedApplicationResizeGestureRecognizerDelegate;              //@synthesize _simulatedApplicationResizeGestureRecognizerDelegate=__simulatedApplicationResizeGestureRecognizerDelegate - In the implementation block
...
-(void)_moveResponderSelectionInDirection:(int)arg1 fromRect:(CGRect)arg2 ;
-(void)loadFirstResponderScrollViewContentInDirection:(CGSize)arg1 ;
-(id)_responderSelectionContainerViewForResponder:(id)arg1 ;
-(char)_isPoint:(CGPoint)arg1 relativeToPoint:(CGPoint)arg2 inDirection:(int)arg3 ;
-(void)_scrollResponderToVisible:(id)arg1 ;
-(void)_setSimulatedApplicationResizeGestureRecognizerDelegate:(id)arg1 ;
-(_UISimulatedApplicationResizeGestureRecognizerDelegate *)_simulatedApplicationResizeGestureRecognizerDelegate;

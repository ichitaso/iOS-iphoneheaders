...
@class NSString, NSUUID, NSObject, HMMessageDispatcher, HMHomeManager, HMRoom, NSMutableArray, NSMutableDictionary, NSArray;
...
@property (nonatomic,retain) NSMutableArray * pendingAccessoriesTransactions;                 //@synthesize pendingAccessoriesTransactions=_pendingAccessoriesTransactions - In the implementation block
...
@property (nonatomic,retain) NSMutableArray * pendingTriggerTransactions;                     //@synthesize pendingTriggerTransactions=_pendingTriggerTransactions - In the implementation block
...
-(HMRoom *)homeAsRoom;
-(NSMutableArray *)pendingAccessoriesTransactions;
-(void)setPendingAccessoriesTransactions:(NSMutableArray *)arg1 ;
-(NSMutableArray *)pendingTriggerTransactions;
-(void)setPendingTriggerTransactions:(NSMutableArray *)arg1 ;
...
-(void)configure:(id)arg1 uuid:(id)arg2 primary:(char)arg3 messageDispatcher:(id)arg4 ;

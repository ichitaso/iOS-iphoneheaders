...
-(id)dataType;
-(id)_initWithAsset:(id)arg1 chapterGroupIndex:(long)arg2 chapterIndex:(long)arg3 chapterType:(id)arg4 locale:(id)arg5 chapterDataType:(id)arg6 time:(SCD_Struct_CM4)arg7 duration:(SCD_Struct_CM4)arg8 ;

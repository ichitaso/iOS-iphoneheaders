...
@class NSString, ABPersonTableViewSharingDelegate, UIView, ABContactViewController, ABPersonViewControllerHelper, ABPersonTableViewDataSource, ABPersonTableViewActionsDelegate, ABUIPerson, NSArray, UITableView, NSMutableArray, UIFont, UIImage;

...
@property (assign) char clientWantsPersons;                                            //@synthesize clientWantsPersons=_clientWantsPersons - In the implementation block
@property (assign) char clientWantsProperties;                                         //@synthesize clientWantsProperties=_clientWantsProperties - In the implementation block
...
-(void)setClientWantsPersons:(char)arg1 ;
-(void)setClientWantsProperties:(char)arg1 ;

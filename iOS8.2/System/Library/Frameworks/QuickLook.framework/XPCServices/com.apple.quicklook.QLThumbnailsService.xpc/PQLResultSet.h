...
#import <com.apple.quicklook.QLThumbnailsService/NSFastEnumeration.h>
...
-(unsigned)countByEnumeratingWithState:(SCD_Struct_PQ2*)arg1 objects:(id*)arg2 count:(unsigned)arg3 ;
-(char)next;
-(void)dealloc;

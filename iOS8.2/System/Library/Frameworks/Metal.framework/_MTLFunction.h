...
@property (readonly) SCD_Struct_MT31 bitcodeHash;                              //@synthesize bitcodeHash=_bitcodeHash - In the implementation block
...
-(int)bitCodeOffset;
-(id)initWithName:(id)arg1 bitcodeHash:(const SCD_Struct_MT31*)arg2 type:(unsigned)arg3 libraryData:(MTLLibraryData*)arg4 offsets:(MTLFunctionOffsets*)arg5 versions:(MTLFunctionVersions*)arg6 device:(id)arg7 ;

...
@class PSSpecifier, NSArray, ACAccountStore, ACAccount, AAUIGenericTermsRemoteUI, UIProgressHUD, RadiosPreferences, NSOperationQueue, PSCloudStorageOffersManager, CPLStatus, NSString;
...
@interface MSSSettingsController : PSListController <PSCloudStorageOffersManagerDelegate, CPLStatusDelegate, UIAlertViewDelegate, UIActionSheetDelegate, RadiosPreferencesDelegate> {
	...
	char _waitingForNonLocalResourceInfo;

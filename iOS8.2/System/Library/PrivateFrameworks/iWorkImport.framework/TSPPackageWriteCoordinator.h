...
@class NSURL, TSPObjectContext, TSPDocumentRevision, TSPArchiverManager, NSObject, TSUPathSet, TSPObjectContainer, NSHashTable, TSPComponentExternalReferenceMap, NSMutableArray, TSPPackageMetadata, NSString;
...
-(id)initWithContext:(id)arg1 documentRevision:(id)arg2 saveToken:(unsigned long long)arg3 packageIdentifier:(unsigned char)arg4 fileFormatVersion:(unsigned long long)arg5 preferredPackageType:(int)arg6 packageWriteCoordinator:(id)arg7 captureSnapshots:(char)arg8 ;
...
-(void)enqueueRootObject:(id)arg1 forceArchive:(char)arg2 completion:(/*^block*/id)arg3 ;
-(void)enqueueRootObjectImpl:(id)arg1 forceArchive:(char)arg2 completion:(/*^block*/id)arg3 ;
...
-(id)explicitComponentRootObjectForObject:(id)arg1 claimingComponent:(id)arg2 isInComponentQueue:(char)arg3 ;
-(void)addDelayedObject:(id)arg1 forComponentRootObject:(id)arg2 claimingComponent:(id)arg3 assertOnFailure:(char)arg4 completion:(/*^block*/id)arg5 ;

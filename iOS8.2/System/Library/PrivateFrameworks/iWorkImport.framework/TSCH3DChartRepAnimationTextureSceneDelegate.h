...
+(id)sceneDelegateWithRep:(id)arg1 scene:(id)arg2 finalElements:(char)arg3 chunkStage:(int)arg4 ;
-(void)clearParent;
...
-(id)initWithRep:(id)arg1 scene:(id)arg2 finalElements:(char)arg3 chunkStage:(int)arg4 ;
-(char)p_shouldSkipIndex:(const tvec2<int>*)arg1 ;
-(void)dealloc;

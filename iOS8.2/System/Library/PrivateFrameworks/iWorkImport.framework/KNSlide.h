...
@interface KNSlide : KNAbstractSlide <TSKModel, TSSThemedObject, TSKTransformableObject> {
	...
	char mInfoUsingObjectPlaceholderGeometryMatchesObjectPlaceholderGeometry;
...
@property (assign,nonatomic) char infoUsingObjectPlaceholderGeometryMatchesObjectPlaceholderGeometry; 
...
-(char)infoUsingObjectPlaceholderGeometryMatchesObjectPlaceholderGeometry;
-(void)setInfoUsingObjectPlaceholderGeometryMatchesObjectPlaceholderGeometry:(char)arg1 ;
-(void)setToMasterUsingBlob:(id)arg1 ;
-(char)isNoteSelectionModel:(id)arg1 ;

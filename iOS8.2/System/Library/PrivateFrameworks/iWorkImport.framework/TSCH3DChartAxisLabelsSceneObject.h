...
-(void)p_renderLabels:(id)arg1 labelType:(int)arg2 part:(TSCH3DScenePart)arg3 positioner:(id)arg4 offset:(const tvec3<float>*)arg5 offset2DBlock:(/*^block*/id)arg6 strideBlock:(/*^block*/id)arg7 skipFirst:(char)arg8 showLast:(char)arg9 ;

...
@class TSCH3DAnimationTimeSlice, TSCH3DGeometryInterleavedArray, NSMutableDictionary, TSCH3DChartGeometryArrayCompiler, TSCH3DGeometryElementArrays, TSCH3DChartElementSceneObject, NSString;
...
+(char)hasCompiledDataForScene:(id)arg1 ;
+(id)scenePropertiesKey;
+(id)compiledDataForScene:(id)arg1 ;
-(TSCH3DChartElementSceneObject *)sceneObject;
...
-(void)setSceneObject:(TSCH3DChartElementSceneObject *)arg1 ;
-(void)dealloc;
@end

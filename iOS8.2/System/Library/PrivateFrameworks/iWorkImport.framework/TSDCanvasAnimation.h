...
@interface TSDCanvasAnimation : NSObject {
	...
	float _repeatCount;
	char _repeatAutoreverses;
	TSUNoCopyDictionary* _animationDictionariesForLayers;
	/*^block*/id _completionBlock;
	unsigned _outstandingAnimationCount;
	char _firstAnimationDidStart;
	char _allAnimationsFinishedBeforeStopping;
...
@property (assign,nonatomic) char repeatAutoreverses;                             //@synthesize repeatAutoreverses=_repeatAutoreverses - In the implementation block

...
-(id)initByCopyingASTNodeArray:(TSCEASTNodeArray*)arg1 formulaID:(SCD_Struct_TS282)arg2 ;
-(TSCEASTNodeArray*)ast;
-(SCD_Struct_TS282)formulaID;
-(id)initWithCReference:(SCD_Struct_TS284*)arg1 formulaID:(SCD_Struct_TS282)arg2 ;
-(void)p_rewriteWithSpec:(id)arg1 ;
-(void)replaceContentsWithContentsOfTrackedReference:(id)arg1 ;
-(void)setFormulaID:(SCD_Struct_TS282)arg1 ;

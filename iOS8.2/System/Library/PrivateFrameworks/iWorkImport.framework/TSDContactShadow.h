...
+(id)contactShadowWithOffset:(float)arg1 height:(float)arg2 radius:(float)arg3 opacity:(float)arg4 color:(CGColorRef)arg5 enabled:(char)arg6 ;
...
-(id)initWithOffset:(float)arg1 height:(float)arg2 radius:(float)arg3 opacity:(float)arg4 color:(CGColorRef)arg5 enabled:(char)arg6 ;

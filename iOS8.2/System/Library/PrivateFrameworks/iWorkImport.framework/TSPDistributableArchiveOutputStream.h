...
-(id)initWithOutputStream:(id)arg1 checkCrc:(unsigned)arg2 enableDescriptors:(char)arg3 enableToc:(char)arg4 closedCleanly:(char)arg5 archivedVersions:(SCD_Struct_TS255)arg6 ;

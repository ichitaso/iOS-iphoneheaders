...
@property (assign,nonatomic) char interpretsUntaggedImageDataAsGeneric; 
...
@property (nonatomic,readonly) char canPasteAsPDF; 
...
-(void)setInterpretsUntaggedImageDataAsGeneric:(char)arg1 ;
-(CGSize)originalSize;

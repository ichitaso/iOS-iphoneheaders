...
+(id)columnForCharIndex:(unsigned)arg1 eol:(char)arg2 withColumns:(id)arg3 ;
+(CGRect)rectForSelection:(id)arg1 withColumns:(id)arg2 useParagraphModeRects:(char)arg3 ;
+(unsigned)charIndexForPoint:(CGPoint)arg1 inColumnsArray:(id)arg2 allowPastBreak:(char)arg3 allowNotFound:(char)arg4 pastCenterGoesToNextChar:(char)arg5 isAtEndOfLine:(char*)arg6 leadingEdge:(char*)arg7 ;
...
+(unsigned)charIndexForPoint:(CGPoint)arg1 inColumnsArray:(id)arg2 allowPastBreak:(char)arg3 allowNotFound:(char)arg4 isAtEndOfLine:(char*)arg5 leadingEdge:(char*)arg6 ;
...
+(CGRect)boundsRectForSelection:(id)arg1 columnArray:(id)arg2 includeRuby:(char)arg3 ;
-(CGRect)frameBounds;
-(id)rectsForSelection:(id)arg1 ;
-(char)textIsVertical;
-(CGRect)typographicBoundsForCell;
-(CGRect)caretRectForSelection:(id)arg1 ;
-(SCD_Struct_TS575)lineMetricsAtCharIndex:(unsigned)arg1 allowEndOfLine:(char)arg2 ;
-(unsigned)lineIndexForCharIndex:(unsigned)arg1 eol:(char)arg2 ;
-(unsigned)countLines;
-(const TSWPLineFragment*)lineFragmentAtIndex:(unsigned)arg1 ;
-(unsigned)charIndexFromPoint:(CGPoint)arg1 allowPastBreak:(char)arg2 pastCenterGoesToNextChar:(char)arg3 allowNotFound:(char)arg4 isAtEndOfLine:(char*)arg5 leadingEdge:(char*)arg6 ;
-(unsigned)charIndexFromPoint:(CGPoint)arg1 allowPastBreak:(char)arg2 pastCenterGoesToNextChar:(char)arg3 allowNotFound:(char)arg4 isAtEndOfLine:(char*)arg5 outFragment:(const TSWPLineFragment*)arg6 leadingEdge:(char*)arg7 ;
...
-(id)rectsForSelectionRange:(NSRange)arg1 selectionType:(int)arg2 forParagraphMode:(char)arg3 includeRuby:(char)arg4 ;
...
-(id)pMutableRectsForSelectionRange:(NSRange)arg1 selectionType:(int)arg2 includeSpaceAfter:(char)arg3 includeSpaceBefore:(char)arg4 includeLeading:(char)arg5 forParagraphMode:(char)arg6 includeRuby:(char)arg7 inranges:(id)arg8 outranges:(id*)arg9 ;
...
-(id)rectsForSelectionRange:(NSRange)arg1 selectionType:(int)arg2 forParagraphMode:(char)arg3 ;
-(unsigned)charIndexFromWPPoint:(CGPoint)arg1 pastCenterGoesToNextChar:(char)arg2 allowNotFound:(char)arg3 outFragment:(const TSWPLineFragment*)arg4 leadingEdge:(char*)arg5 ;
-(NSRange)anchoredRange;
-(void)renderWithRenderer:(id)arg1 currentSelection:(id)arg2 limitSelection:(id)arg3 listRange:(NSRange)arg4 rubyGlyphRange:(NSRange)arg5 isCanvasInteractive:(char)arg6 suppressedMisspellingRange:(NSRange)arg7 blackAndWhite:(char)arg8 dictationInterpretations:(const TSWPRangeVector*)arg9 autocorrections:(const TSWPRangeVector*)arg10 markedRange:(NSRange)arg11 markedText:(id)arg12 renderMode:(int)arg13 pageCount:(unsigned)arg14 suppressInvisibles:(char)arg15 currentCanvasSelection:(id)arg16 ;
-(CGRect)wpBounds;
...
-(CGRect)changeBarRectForLineFragment:(const TSWPLineFragment*)arg1 ;
...
-(float)horizontalOffsetForCharIndex:(unsigned)arg1 lineFragmentIndex:(unsigned)arg2 bumpPastHyphen:(char)arg3 allowPastLineBounds:(char)arg4 ;
-(const TSWPLineFragment*)lineFragmentClosestToPoint:(CGPoint)arg1 knobTag:(unsigned)arg2 ;
-(const TSWPLineFragment*)nearestLineFragmentWithSameVerticalPositionAs:(unsigned)arg1 xPos:(float)arg2 ;
...
-(unsigned)charIndexForSelectionFromPoint:(CGPoint)arg1 isTail:(char)arg2 ;
-(TSWPCharIndexAndPosition)calcAttachmentPositionForDrawable:(id)arg1 atPoint:(CGPoint)arg2 inTextLayoutTarget:(id)arg3 tlBoundsInfluencingWrap:(CGPoint)arg4 wrapOutset:(CGSize)arg5 wrapMargin:(float)arg6 makeInline:(char)arg7 ;

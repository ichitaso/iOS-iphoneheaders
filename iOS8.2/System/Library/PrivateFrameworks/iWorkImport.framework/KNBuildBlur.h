...
@class KNAnimParameterGroup, TSDGLShader, NSMapTable, NSString;
...
+(void)addBlurTexturesToMapTable:(id)arg1 andDataBuffersToMapTable:(id)arg2 withTextures:(id)arg3 blurSteps:(unsigned)arg4 maxBlurRadius:(float)arg5 stepsToDecreaseRadius:(float)arg6 capabilities:(id)arg7 ;

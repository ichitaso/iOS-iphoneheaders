...
+(id)generateParticles:(unsigned)arg1 withBounds:(CGRect)arg2 direction:(unsigned)arg3 animationContext:(id)arg4 ;
+(id)layersFromParticles:(id)arg1 withBounds:(CGRect)arg2 mainLayer:(id)arg3 direction:(unsigned)arg4 animationContext:(id)arg5 ;

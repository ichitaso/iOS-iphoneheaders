...
-(id)stagedUploadURLWithContainer:(id)arg1 itemID:(id)arg2 suffix:(id)arg3 kind:(unsigned)arg4 ;
...
-(char)moveToStageFromTmp:(id)arg1 gatherFileID:(unsigned long long*)arg2 generationID:(unsigned*)arg3 documentID:(unsigned*)arg4 inContainer:(id)arg5 error:(id*)arg6 ;
-(id)stagedUploadAssetWithContainer:(id)arg1 itemID:(id)arg2 suffix:(id)arg3 kind:(unsigned)arg4 error:(id*)arg5 ;
...
-(unsigned long long)packageRootFileIDForManifestID:(id)arg1 createIfMissing:(char)arg2 error:(id*)arg3 ;
-(char)beginStageOfPackageWithManifestID:(id)arg1 manifestPath:(id)arg2 error:(id*)arg3 ;
-(char)manifestFileIDsForManifestID:(id)arg1 manifestFileID:(unsigned long long*)arg2 stagingManifestFileID:(unsigned long long*)arg3 error:(id*)arg4 ;
-(char)copyPackageFileWithPackageFd:(int)arg1 toStageFd:(int)arg2 relpath:(id)arg3 ;
-(id)stagedManifestURLForManifestID:(id)arg1 ;
-(char)movePackageFromStageToGraveyard:(id)arg1 ;
...
-(char)isItemInStageWithParentFileID:(unsigned long long)arg1 error:(id*)arg2 ;
...
-(char)manifestExistsInStageWithManifestID:(id)arg1 gatherPackageFileID:(unsigned long long*)arg2 gatherManifestFileID:(unsigned long long*)arg3 ;
-(char)finishStageOfPackageWithManifestID:(id)arg1 gatherFileID:(unsigned long long*)arg2 generationID:(unsigned*)arg3 documentID:(unsigned*)arg4 inContainer:(id)arg5 error:(id*)arg6 ;

...
@class NSXPCListenerEndpoint, NSMutableArray, NSString;
...
@property (nonatomic,retain) NSMutableArray * pendingReplies;              //@synthesize pendingReplies=_pendingReplies - In the implementation block
...
-(void)setPendingReplies:(NSMutableArray *)arg1 ;

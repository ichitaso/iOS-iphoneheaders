...
-(void)ensureTokenRefreshForAppContainerTuple:(id)arg1 apsEnvironmentString:(id)arg2 useAPSPublicToken:(char)arg3 completionBlock:(/*^block*/id)arg4 ;
...
-(void)_refreshToken:(id)arg1 appContainerTuple:(id)arg2 apsEnvironmentString:(id)arg3 usesAPSPublicToken:(int)arg4 completionBlock:(/*^block*/id)arg5 ;
-(void)_removeToken:(id)arg1 appContainerTuple:(id)arg2 apsEnvironmentString:(id)arg3 usesAPSPublicToken:(int)arg4 completionBlock:(/*^block*/id)arg5 ;

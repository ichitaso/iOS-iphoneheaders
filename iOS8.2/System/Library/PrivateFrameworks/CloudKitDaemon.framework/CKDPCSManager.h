...
-(void)fetchPCSForZoneWithID:(id)arg1 operation:(id)arg2 fetchFromServer:(char)arg3 withCompletionHandler:(/*^block*/id)arg4 ;
...
-(void)fetchPCSForRecordWithID:(id)arg1 operation:(id)arg2 fetchFromServer:(char)arg3 withCompletionHandler:(/*^block*/id)arg4 ;
-(void)fetchPCSForShareWithID:(id)arg1 operation:(id)arg2 fetchFromServer:(char)arg3 withCompletionHandler:(/*^block*/id)arg4 ;

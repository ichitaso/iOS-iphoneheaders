...
@interface AXRemoteElement : NSObject {
	...
	char _remoteSideShouldActAsOpaqueElementProvider;
	unsigned _machPort;
...
@property (assign,nonatomic) char remoteSideShouldActAsOpaqueElementProvider;                         //@synthesize remoteSideShouldActAsOpaqueElementProvider=_remoteSideShouldActAsOpaqueElementProvider - In the implementation block
+(void)initialize;
...
-(void)setRemoteSideShouldActAsOpaqueElementProvider:(char)arg1 ;
-(char)remoteSideShouldActAsOpaqueElementProvider;

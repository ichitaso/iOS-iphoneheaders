...
@interface CUIShapeEffectStack : NSObject {
	...
	SCD_Struct_CU29 colorOverlay;
	BOOL hasInnerGradient;
	SCD_Struct_CU30 innerGradient;
	BOOL hasInnerGlow;
	SCD_Struct_CU31 innerGlow;
	BOOL hasInnerShadow;
	SCD_Struct_CU32 insideShadow;
	BOOL hasOuterGlow;
	SCD_Struct_CU33 outerGlow;
	BOOL hasEngraveShadow;
	SCD_Struct_CU34 engraveShadow;
	BOOL hasExtraShadow;
	SCD_Struct_CU34 extraShadow;
	BOOL hasBevelEmboss;
	SCD_Struct_CU35 emboss;
	float scalefactor;
	int renderStrategy;
...
+(id)gradientWithParameters:(SCD_Struct_CU30*)arg1 inRect:(CGRect)arg2 ;

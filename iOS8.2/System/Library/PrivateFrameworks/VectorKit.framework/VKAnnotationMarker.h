...
@interface VKAnnotationMarker : VKAnnotationMarkerLayer <VKAnchorDelegate, VKTrackableAnnotationPresentation, MKCalloutSource> {
	...
	SCD_Struct_VK255 _presentationCoordinate;
...
@property (assign,nonatomic) SCD_Struct_VK255 presentationCoordinate; 
...
-(char)canAnimateIn;
-(SCD_Struct_VK255)presentationCoordinate;
-(char)followsTerrain;
...
-(void)setPresentationCoordinate:(SCD_Struct_VK255)arg1 ;
-(id)initWithAnnotation:(id)arg1 reuseIdentifier:(id)arg2 ;
-(void)setFollowsTerrain:(char)arg1 ;
-(void)setDragState:(int)arg1 ;
-(void)animateFromCoordinate:(SCD_Struct_VK255)arg1 duration:(double)arg2 ;

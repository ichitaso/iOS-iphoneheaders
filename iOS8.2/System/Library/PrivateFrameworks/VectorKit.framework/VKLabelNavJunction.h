...
@interface VKLabelNavJunction : NSObject <VKLabelNavFeature> {
	...
	SCD_Struct_VK488* _labelFeature;
	NSString* _name;
...
@property (nonatomic,readonly) const SCD_Struct_VK443* geoJunction;              //@synthesize geoJunction=_geoJunction - In the implementation block
...
-(id)initWithGEOJunction:(SCD_Struct_VK443*)arg1 routeOffset:(PolylineCoordinate)arg2 tile:(id)arg3 ;
-(id)initWithRoadEdge:(const SCD_Struct_VK446*)arg1 atA:(char)arg2 routeOffset:(PolylineCoordinate)arg3 tile:(id)arg4 ;
...
-(const SCD_Struct_VK443*)geoJunction;

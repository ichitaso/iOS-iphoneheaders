...
@property (assign,nonatomic) char disableRealisticRoads;                                  //@synthesize disableRealisticRoads=_disableRealisticRoads - In the implementation block
@property (assign,nonatomic) char disableRealisticLand;                                   //@synthesize disableRealisticLand=_disableRealisticLand - In the implementation block
...
-(void)appendLandCommandsToBuffer:(CommandBuffer*)arg1 inContext:(id)arg2 skyParameters:(const SCD_Struct_VK279*)arg3 ;
-(void)appendWaterCommandsToBuffer:(CommandBuffer*)arg1 inContext:(id)arg2 skyParameters:(const SCD_Struct_VK279*)arg3 ;
-(void)appendRoadCommandsToBuffer:(CommandBuffer*)arg1 inContext:(id)arg2 skyParameters:(const SCD_Struct_VK279*)arg3 ;

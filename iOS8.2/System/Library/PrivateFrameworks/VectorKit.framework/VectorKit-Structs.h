...
typedef struct {
	...
	= field10;
	SCD_Struct_VK286 field11;
	SCD_Struct_VK287) field12;
	/*function pointer*/void* field13;
	SCD_Struct_VK288 field14;
...
typedef struct {
	SCD_Struct_VK378 _color;
	float _offsetX;
	float _offsetY;
	float _size;
	SCD_Struct_VK379 _has;
} SCD_Struct_VK380;
...
typedef struct {
	SCD_Struct_VK255 center;
	SCD_Struct_VK255 span;
} SCD_Struct_VK420;
...
typedef struct StyleData {
	SCD_Struct_VK523 hasValueInStylesheet;

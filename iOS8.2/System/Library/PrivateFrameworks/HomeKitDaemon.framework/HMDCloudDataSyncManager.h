...
@property (assign,nonatomic) char cloudRecordExists;                                              //@synthesize cloudRecordExists=_cloudRecordExists - In the implementation block
...
-(void)setCloudRecordExists:(char)arg1 ;

...
-(void)_configureAsClient:(char)arg1 queue:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(id)initWithDestination:(id)arg1 messageDispatcher:(id)arg2 notificationDispatcher:(id)arg3 identityRegistry:(id)arg4 notificationRelay:(id)arg5 clientMode:(char)arg6 sessionID:(id)arg7 ;

...
@class NSString, NSURL, NSDate, NSError, UIImage, NSDictionary, NSData, NSSet, PLCloudMaster, PLCloudFeedAssetsEntry, NSNumber, NSOrderedSet, PLAdditionalAssetAttributes, PLMoment, NSManagedObject, CLLocation, NSArray;
...
@property (assign,nonatomic) SCD_Struct_PL8 gpsCoordinate; 
...
+(SCD_Struct_PL8)locationFromAVAsset:(id)arg1 ;
...
+(void)duplicateResourceIn:(id)arg1 forAsset:(id)arg2 forType:(unsigned)arg3 inManagedObjectContext:(id)arg4 ;
...
+(unsigned)numberOfCPLSupportedAssetsOfKind:(short)arg1 inPhotoLibrary:(id)arg2 includeTrashed:(char)arg3 ;
...
-(id)cplAssetChangeWithMasterID:(id)arg1 withChangeType:(unsigned)arg2 ;
...
-(id)locationMergedWithAssetMetadataIfCompact:(char)arg1 ;
...
-(void)setLocationFromCoordinate:(SCD_Struct_PL8)arg1 ;
...
-(char)_isResourceAvailableForResourceType:(unsigned)arg1 ;
...
-(char)isFavorite;
-(char)isLocatedAtCoordinates:(SCD_Struct_PL8)arg1 ;
...
-(SCD_Struct_PL8)gpsCoordinate;
-(void)setGpsCoordinate:(SCD_Struct_PL8)arg1 ;
-(char)isUsedByiPhoto;
-(char)isHDVideo;
-(char)isPanorama;
...
-(char)canGenerateDerivatives;
-(void)setCloudResources:(NSSet *)arg1 ;
-(CGSize)_sizeOfImageAtURL:(id)arg1 ;
-(id)_createCPLResourceFromResourcePath:(id)arg1 withResourceType:(unsigned)arg2 uniformTypeIdentifier:(id)arg3 itemIdentifier:(id)arg4 imageSize:(CGSize)arg5 ;
...
-(void)_createResourcesFromExistingCloudResources:(id)arg1 withItemIdentifier:(id)arg2 fileURLToGenerateDerivatives:(id)arg3 applyAdjustment:(char)arg4 validResources:(id)arg5 invalidResources:(id)arg6 forMaster:(char)arg7 ;
...
-(id)_fileNameFormatForResourceType:(unsigned)arg1 ;
-(void)_debugPrintAdjustmentState;
-(unsigned)_cplAdjustmentSourceTypeFromPLAdjustmentBaseVersion:(int)arg1 ;
-(char)_hasProcessedTypes:(id)arg1 forType:(unsigned)arg2 ;
...
-(void)applyResourceChangeToCPLAsset:(id)arg1 withIdentifier:(id)arg2 forChangeType:(unsigned)arg3 ;

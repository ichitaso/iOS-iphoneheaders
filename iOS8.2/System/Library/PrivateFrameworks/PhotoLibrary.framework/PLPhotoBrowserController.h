...
@class NSMutableDictionary, UIPageController, UIScrollView, UIView, UITransitionView, NSIndexPath, NSNumberFormatter, UIActionSheet, UIAlertView, PLProgressHUD, NSTimer, PHAsset, UIWindow, PLProgressView, PLVideoRemaker, UILongPressGestureRecognizer, PLEditPhotoController, NSArray, PHCachingImageManager, UIImage, PLPhotoScrubber, PLPhotoTileViewController, PLPictureFramePlugin, NSString, PLAirPlaySession, PLAirPlayBackgroundView, PLDeletePhotosActionController, UINavigationBar, NSMutableArray, NSManagedObjectID, PLAssetContainerDataSource, PHAssetCollection, PHFetchResult, PLVideoView, NSDictionary;

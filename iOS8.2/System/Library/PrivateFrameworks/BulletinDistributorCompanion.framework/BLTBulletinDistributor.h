...
-(void)_notifyGizmoOfCancelBulletin:(id)arg1 universalSectionID:(id)arg2 feed:(unsigned)arg3 ;
...
-(void)_notifyGizmoOfBulletin:(id)arg1 forFeed:(unsigned)arg2 updateType:(unsigned)arg3 playLightsAndSirens:(char)arg4 shouldSendReplyIfNeeded:(char)arg5 ;

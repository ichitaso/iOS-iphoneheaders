...
@interface CAMApplicationViewController : CAMCameraViewController <CAMCameraRollObserver, PLPhotoBrowserControllerDelegate, UINavigationControllerDelegate> {
	...
	char __handlesVolumeButtons;
	char __ignoringVolumeButtons;
...
@property (assign,setter=_setHandlesVolumeButtons:,nonatomic) char _handlesVolumeButtons;                                                                                    //@synthesize _handlesVolumeButtons=__handlesVolumeButtons - In the implementation block
@property (assign,setter=_setIgnoringVolumeButtons:,nonatomic) char _ignoringVolumeButtons;                                                                                  //@synthesize _ignoringVolumeButtons=__ignoringVolumeButtons - In the implementation block
...
-(void)_setWantsVolumeButtonEvents:(char)arg1 ;
...
-(char)_handlesVolumeButtons;
-(void)_setHandlesVolumeButtons:(char)arg1 ;
-(char)_ignoringVolumeButtons;
-(void)_setIgnoringVolumeButtons:(char)arg1 ;

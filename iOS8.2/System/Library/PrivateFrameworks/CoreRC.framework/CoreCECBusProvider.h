...
-(id)addDeviceWithLogicalAddress:(unsigned char)arg1 physicalAddress:(id)arg2 deviceType:(unsigned)arg3 message:(id)arg4 reason:(unsigned)arg5 ;
...
-(char)updateActiveSource:(id)arg1 error:(id*)arg2 ;

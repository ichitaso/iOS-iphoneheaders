...
-(id)_initWithMap:(id)arg1 zoomLevel:(unsigned)arg2 tileSize:(int)arg3 tileScale:(int)arg4 tileStyle:(int)arg5 center:(SCD_Struct_GE14)arg6 radius:(double)arg7 ;

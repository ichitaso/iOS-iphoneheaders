...
-(void)setExtAttributes:(SCD_Struct_GE141*)arg1 count:(unsigned)arg2 ;
-(id)initWithSharedStyleAttributes:(id)arg1 extAttributes:(SCD_Struct_GE141*)arg2 extAttributeCount:(unsigned char)arg3 ;
...
-(char)isRamp;
-(int)drivingSide;
-(void)replaceAttributes:(SCD_Struct_GE140*)arg1 count:(unsigned)arg2 ;
@end

...
@interface GEORoute : PBCodable <NSCopying> {
	...
	SCD_Struct_GE55* _advisorys;
	SCD_Struct_GE47* _incidentEndOffsetsInRoutes;
	SCD_Struct_GE47* _incidentIndices;
	SCD_Struct_GE47* _trafficColorOffsets;
	SCD_Struct_GE47* _trafficColors;

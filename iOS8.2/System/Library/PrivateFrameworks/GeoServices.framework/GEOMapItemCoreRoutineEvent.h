...
@class NSDictionary, GEOMapItemClientAttributes, GEOPlace, NSString, NSDate, NSData, GEOMapRegion, GEOAddress, NSArray, GEOPDPlace, GEOPDFlyover, NSURL, GEOMapItemPlaceAttribution, GEOMapItemPhotosAttribution, GEOMapItemReviewsAttribution, GEOFeatureStyleAttributes;
...
-(NSDate *)eventDate;
-(char)isEventAllDay;
-(id)initWithAddressDictionary:(id)arg1 eventName:(id)arg2 eventTitle:(id)arg3 eventDate:(id)arg4 eventIsAllDay:(char)arg5 coordinate:(SCD_Struct_GE14)arg6 clientAttributes:(id)arg7 ;

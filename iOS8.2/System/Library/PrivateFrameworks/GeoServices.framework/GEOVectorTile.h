...
@interface GEOVectorTile : NSObject {
	...
	SCD_Struct_GE96* _lines;
	unsigned _linesCount;
	unsigned _linesVertexCount;
	SCD_Struct_GE96* _coastlines;
	unsigned _coastlinesCount;
	SCD_Struct_GE121* _polygons;
	...
	SCD_Struct_GE122* _buildingFootprints;
	NSMutableData* _extrusionHeightsPool;
	NSMutableData* _baseHeightsPool;
	unsigned _buildingFootprintsCount;
	SCD_Struct_GE122* _hiResBuildingFootprints;
	unsigned _hiResBuildingFootprintsCount;
	SCD_Struct_GE123* _threeDBuildings;
	unsigned _threeDBuildingsCount;
	SCD_Struct_GE124* _extendedPointAttributes;
	unsigned _extendedPointAttributesCount;
	SCD_Struct_GE125* _pois;
	unsigned _poisCount;
	SCD_Struct_GE126* _overpasses;
	SCD_Struct_GE109* _junctions;
	unsigned _junctionsCount;
	char _hasComputedJunctions;
	SCD_Struct_GE127* _laneConnections;
	unsigned _laneConnectionsCount;
	SCD_Struct_GE127* _pointsOnRoad;
	unsigned _pointsOnRoadCount;
	/*function pointer*/void** _sortedPointsOnRoad;
	SCD_Struct_GE128* _laneGeometry;
	SCD_Struct_GE129* _curveLineVertices;
	unsigned* _curveToLineMapping;
	SCD_Struct_GE129* _lineVertices;
	SCD_Struct_GE129* _polygonVertices;
	SCD_Struct_GE129* _coastlineVertices;
	SCD_Struct_GE129* _footprintVertices;
	SCD_Struct_GE129* _hiResFootprintVertices;
	NSData* _labelPool;
	SCD_Struct_GE130* _labelPoolLanguages;
	unsigned _labelPoolLanguagesLength;
	NSMutableData* _localizedLabelPool;
	char* _localizedLabelsLanguage;
	SCD_Struct_GE131* _labelIndex;
	unsigned _labelIndexCount;
	GEOFeatureShield* _shieldIndex;
	unsigned _shieldIndexCount;
	SCD_Struct_GE132* _localizationTable;
	unsigned _localizationTableCount;
	NSMutableOrderedSet* _uniqueAttributes;
	NSMutableArray* _uniqueFeatureAttributes;
	SCD_Struct_GE135* _lineCharacteristicPoints;
	unsigned _lineCharacteristicPointCount;
	SCD_Struct_GE135* _polygonCharacteristicPoints;
	unsigned _polygonCharacteristicPointCount;
	SCD_Struct_GE135* _coastlineCharacteristicPoints;
...
@property (nonatomic,readonly) SCD_Struct_GE96* lines;                                       //@synthesize lines=_lines - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE96* coastlines;                                  //@synthesize coastlines=_coastlines - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE121* polygons;                                   //@synthesize polygons=_polygons - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE122* buildingFootprints;                         //@synthesize buildingFootprints=_buildingFootprints - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE122* hiResBuildingFootprints;                    //@synthesize hiResBuildingFootprints=_hiResBuildingFootprints - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE123* threeDBuildings;                            //@synthesize threeDBuildings=_threeDBuildings - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE125* pois;                                       //@synthesize pois=_pois - In the implementation block
@property (nonatomic,readonly) unsigned poisCount;                                           //@synthesize poisCount=_poisCount - In the implementation block
@property (nonatomic,readonly) SCD_Struct_GE126* overpasses;                                 //@synthesize overpasses=_overpasses - In the implementation block
@property (nonatomic,readonly) SCD_Struct_GE109* junctions;                                  //@synthesize junctions=_junctions - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE127* pointsOnRoad;                               //@synthesize pointsOnRoad=_pointsOnRoad - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE127* laneConnections;                            //@synthesize laneConnections=_laneConnections - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE135* lineCharacteristicPoints;                   //@synthesize lineCharacteristicPoints=_lineCharacteristicPoints - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE135* polygonCharacteristicPoints;                //@synthesize polygonCharacteristicPoints=_polygonCharacteristicPoints - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE135* coastlineCharacteristicPoints;              //@synthesize coastlineCharacteristicPoints=_coastlineCharacteristicPoints - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE129* curveLineVertices; 
@property (nonatomic,readonly) SCD_Struct_GE129* lineVertices; 
...
-(SCD_Struct_GE129*)curveLineVertices;
...
-(void)forEachJunctionInRoad:(SCD_Struct_GE96*)arg1 visitor:(/*^block*/id)arg2 ;
-(unsigned)linesVertexCount;
-(unsigned)polygonsVertexCount;
-(char)dataIncludesConnectivity;
-(SCD_Struct_GE96*)multiSectionFeatureForGeoID:(unsigned long long)arg1 ;
-(SCD_Struct_GE122*)hiResBuildingFootprints;
-(unsigned)hiResBuildingFootprintsCount;
-(char)hasComputedJunctions;
-(unsigned)pointsOnRoadCount;
-(SCD_Struct_GE127*)laneConnections;
-(unsigned)laneConnectionsCount;
-(SCD_Struct_GE135*)lineCharacteristicPoints;
-(unsigned)lineCharacteristicPointCount;
-(SCD_Struct_GE135*)polygonCharacteristicPoints;
-(unsigned)polygonCharacteristicPointCount;
-(SCD_Struct_GE135*)coastlineCharacteristicPoints;
...
-(char)_readPolygons:(SCD_Struct_GE137*)arg1 ofType:(unsigned short)arg2 ;
-(char)_readLowResBuildings:(SCD_Struct_GE137*)arg1 ;
-(char)_readWrappingCoastlines:(SCD_Struct_GE139*)arg1 tile:(SCD_Struct_GE137*)arg2 ;
-(char)_readSimpleCoastlines:(SCD_Struct_GE139*)arg1 tile:(SCD_Struct_GE137*)arg2 ;
-(char)_readModernBuildings:(SCD_Struct_GE137*)arg1 chapter:(unsigned short)arg2 vertexPool:(/*function pointer*/void**)arg3 footprints:(/*function pointer*/void**)arg4 count:(unsigned*)arg5 ;
-(char)_addGenericPolygonWithAttributes:(int*)arg1 ;
-(char)_handleGenericTile:(SCD_Struct_GE137*)arg1 ;
-(char)_readInfoChapter:(SCD_Struct_GE137*)arg1 key:(const GEOTileKey*)arg2 ;
-(char)_readLabels:(SCD_Struct_GE137*)arg1 ;
-(char)_readPois:(SCD_Struct_GE137*)arg1 ;
-(char)_readLines:(SCD_Struct_GE137*)arg1 ;
-(char)_readPolygons:(SCD_Struct_GE137*)arg1 ;
-(char)_readCoastlines:(SCD_Struct_GE137*)arg1 ;
-(char)_read3DBuildings:(SCD_Struct_GE137*)arg1 ;
-(char)_readHighResBuildings:(SCD_Struct_GE137*)arg1 ;
-(char)_readTileReferences:(SCD_Struct_GE137*)arg1 key:(const GEOTileKey*)arg2 ;
-(char)_readExtendedPointAttributes:(SCD_Struct_GE137*)arg1 ;
-(SCD_Struct_GE122*)buildingFootprints;
-(unsigned)buildingFootprintsCount;
-(unsigned)poisCount;
-(SCD_Struct_GE125*)pois;
-(unsigned)linesCount;
-(SCD_Struct_GE96*)lines;
-(unsigned)polygonsCount;
-(SCD_Struct_GE121*)polygons;
-(unsigned)coastlinesCount;
-(SCD_Struct_GE96*)coastlines;
-(GEOTileKey)tileKey;
-(SCD_Struct_GE129*)lineVertices;
-(unsigned)junctionsCount;
-(SCD_Struct_GE127*)pointsOnRoad;
-(SCD_Struct_GE109*)junctions;
-(SCD_Struct_GE126*)overpasses;
-(void)forEachEdgeOnJunction:(const SCD_Struct_GE109*)arg1 visitor:(/*^block*/id)arg2 ;
-(void)forEachEdgeInRoad:(SCD_Struct_GE96*)arg1 visitTwice:(char)arg2 visitor:(/*^block*/id)arg3 ;
...
-(SCD_Struct_GE123*)threeDBuildings;

...
@class GEOPDPlace, GEOPlace, GEOMapServiceTraits, NSMapTable, GEOPDMultiLocalizedString, NSString, NSData, GEOMapRegion, GEOAddress, NSDictionary, NSArray, NSDate, GEOMapItemClientAttributes, GEOPDFlyover, NSURL, GEOMapItemPlaceAttribution, GEOMapItemPhotosAttribution, GEOMapItemReviewsAttribution, GEOFeatureStyleAttributes;
...
-(id)_urlForAttribution:(id)arg1 requirement:(int)arg2 withUID:(id)arg3 writeAReview:(char)arg4 ;

...
+(id)composedWaypointForCoordinate:(SCD_Struct_GE14)arg1 addressDictionary:(id)arg2 placeName:(id)arg3 traits:(id)arg4 completionHandler:(/*^block*/id)arg5 networkActivityHandler:(/*^block*/id)arg6 ;
-(void)dealloc;

...
-(unsigned)maximumZoomLevelInRect:(SCD_Struct_GE53)arg1 ;
...
-(unsigned)minimumZoomLevelInRect:(SCD_Struct_GE53)arg1 ;
-(unsigned)timeToLiveSeconds;
-(unsigned)largestZoomLevelLEQ:(unsigned)arg1 inRect:(SCD_Struct_GE53)arg2 ;
@end

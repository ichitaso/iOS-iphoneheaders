...
+(id)_mapkit_mapRegionForCoordinateRegion:(SCD_Struct_GE53)arg1 ;
+(id)_mapkit_mapRegionEnclosingAnnotations:(id)arg1 ;
+(id)_mapkit_mapRegionForGEOCoordinateRegion:(SCD_Struct_GE53)arg1 ;
...
-(void)setMapRect:(SCD_Struct_GE53)arg1 ;
-(id)initWithRadialPlace:(id)arg1 ;
-(double)centerLat;
-(double)centerLng;
-(double)spanLat;
-(double)spanLng;
-(char)containsCoordinate:(SCD_Struct_GE14)arg1 ;
-(char)containsMapRect:(SCD_Struct_GE53)arg1 ;
...
-(id)initWithMapRect:(SCD_Struct_GE53)arg1 ;
-(void)addVertex:(id)arg1 ;
-(void)mergeFrom:(id)arg1 ;
-(char)readFrom:(id)arg1 ;
-(void)writeTo:(id)arg1 ;
-(void)copyTo:(id)arg1 ;
-(id)initWithCoordinateRegion:(SCD_Struct_GE53)arg1 ;
@end

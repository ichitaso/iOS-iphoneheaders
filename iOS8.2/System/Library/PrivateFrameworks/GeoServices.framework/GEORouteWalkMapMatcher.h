...
-(SCD_Struct_GE152)_matchToRouteFromLocation:(id)arg1 trackedLocation:(id)arg2 distanceLeftToSearch:(double)arg3 ;
-(SCD_Struct_GE152)_determineBestMatch:(const SCD_Struct_GE152*)arg1 trackedLocation:(id)arg2 rawLocation:(id)arg3 ;

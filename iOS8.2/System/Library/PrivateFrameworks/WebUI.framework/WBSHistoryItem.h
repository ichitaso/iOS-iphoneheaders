...
-(Vector<double, 0, WTF::CrashOnOverflow>*)_timesForSynthesizedVisitsPreceedingDailyAndWeeklyRange:(unsigned)arg1 ;
...
-(Vector<double, 0, WTF::CrashOnOverflow>*)_timesForVisits:(unsigned)arg1 toSynthesizeBetweenStartTime:(double)arg2 endTime:(double)arg3 ;

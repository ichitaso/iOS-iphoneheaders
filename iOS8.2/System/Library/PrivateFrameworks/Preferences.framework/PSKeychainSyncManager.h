...
-(char)registerUserCredentialsName:(id)arg1 password:(id)arg2 error:(id*)arg3 ;
...
-(id)preferencesApp;
-(char)_changeSecurityCode:(id)arg1 type:(int)arg2 smsTarget:(id)arg3 smsTargetCountryInfo:(id)arg4 username:(id)arg5 password:(id)arg6 error:(id*)arg7 ;

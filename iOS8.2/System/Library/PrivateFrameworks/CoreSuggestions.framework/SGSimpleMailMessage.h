...
@property (assign,nonatomic) char isInhuman;                                         //@synthesize isInhuman=_isInhuman - In the implementation block
...
-(void)setIsInhuman:(char)arg1 ;
-(char)isEqualToSimpleMailMessage:(id)arg1 ;
-(id)asDictionary;
-(NSNumber *)received;
-(NSString *)htmlBody;
-(char)isInhuman;

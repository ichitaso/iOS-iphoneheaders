...
@class NSObject, NSXPCListener, NSMutableDictionary, MLDMediaLibraryWriter, MLDDatabaseImportManager, NSOperationQueue, NSTimer, NSString, NSMutableSet, NSLock;
...
-(oneway void)performImportFromSource:(unsigned)arg1 intoDatabaseAtPath:(id)arg2 withTrackData:(id)arg3 withPlaylistData:(id)arg4 withFileHandle:(id)arg5 options:(id)arg6 identifier:(id)arg7 completionHandler:(/*^block*/id)arg8 ;

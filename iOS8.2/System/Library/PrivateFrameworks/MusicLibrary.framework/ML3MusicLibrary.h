...
@class NSObject, NSString, ML3AccountCacheDatabase, ML3LibraryNotificationManager, ML3SortMapSections, NSMutableDictionary, ML3DatabaseConnectionPool, NSArray, ML3Container, ML3DatabaseMetadata;

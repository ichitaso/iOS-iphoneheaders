...
@property (nonatomic,readonly) NSString * nameOrderPropertyForSectionProperty; 
...
@property (nonatomic,copy) NSArray * propertiesToPrefetch;                                         //@synthesize propertiesToPrefetch=_propertiesToPrefetch - In the implementation block
...
-(NSString *)nameOrderPropertyForSectionProperty;
-(char)filtersOnDynamicProperties;
-(NSArray *)propertiesToPrefetch;
-(void)setPropertiesToPrefetch:(NSArray *)arg1 ;
-(void)enumeratePersistentIDsAndProperties:(id)arg1 ordered:(char)arg2 sectionProperty:(id)arg3 subCollectionProperty:(id)arg4 cancelBlock:(/*^block*/id)arg5 usingBlock:(/*^block*/id)arg6 ;
@end

...
-(long long)addReferencesForMessage:(id)arg1 libraryID:(unsigned)arg2 messageIDHash:(long long)arg3 withSubject:(id)arg4 withReferences:(id)arg5 usingDatabase:(sqlite3Ref)arg6 otherSubjectIDMappings:(id)arg7 usingMailbox:(int)arg8 conversationFlags:(unsigned long long*)arg9 mergeHandler:(/*^block*/id)arg10 ;
...
-(char)cleanupProtectedTables:(sqlite3Ref)arg1 checkForInconsistencies:(char)arg2 ;

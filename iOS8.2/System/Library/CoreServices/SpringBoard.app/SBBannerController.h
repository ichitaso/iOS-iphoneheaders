...
-(void)_dismissBannerWithAnimation:(char)arg1 reason:(int)arg2 forceEvenIfBusy:(char)arg3 completion:(/*^block*/id)arg4 ;
...
-(void)_setLockScreenContentHidden:(char)arg1 ;

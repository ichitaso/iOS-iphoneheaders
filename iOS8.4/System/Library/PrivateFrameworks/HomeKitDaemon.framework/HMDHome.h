...
@property (assign,nonatomic) long long bootupRemoteAccessOnceToken;                           //@synthesize bootupRemoteAccessOnceToken=_bootupRemoteAccessOnceToken - In the implementation block
...
-(void)_performAddPairingForUser:(id)arg1 destination:(id)arg2 remotePeer:(BOOL)arg3 userPrivilege:(unsigned long long)arg4 controllerInfo:(id)arg5 identifier:(id)arg6 responseHandler:(/*^block*/id)arg7 ;

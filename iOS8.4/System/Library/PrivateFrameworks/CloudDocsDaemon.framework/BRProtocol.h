...
-(void)setMigrationStatus:(char)arg1 forDSID:(id)arg2 shouldNotify:(BOOL)arg3 reply:(/*^block*/id)arg4;
...
-(void)startOperation:(id)arg1 toCopySharingAccessToken:(id)arg2 wantsPermissions:(BOOL)arg3 reply:(/*^block*/id)arg4;

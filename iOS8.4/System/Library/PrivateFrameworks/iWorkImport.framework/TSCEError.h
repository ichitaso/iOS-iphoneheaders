...
+(void)raiseErrorForInvalidReference:(SCD_Struct_TS322*)arg1 orString:(id)arg2 contextEntityID:(CFUUIDRef)arg3 invalidMergeReference:(BOOL)arg4 disqualifiedFromEndCell:(BOOL)arg5 ;
...
+(id)indirectErrorForRangeReference:(SCD_Struct_TS322*)arg1 hostTableID:(CFUUIDRef)arg2 calculationEngine:(id)arg3 ;
...
+(void)raiseErrorForInvalidReference:(SCD_Struct_TS322*)arg1 orString:(id)arg2 contextEntityID:(CFUUIDRef)arg3 ;
+(id)invalidMergeReference:(SCD_Struct_TS322*)arg1 contextEntityID:(CFUUIDRef)arg2 ;
...
+(void)raiseIndirectErrorForRangeReference:(SCD_Struct_TS322*)arg1 hostTableID:(CFUUIDRef)arg2 calculationEngine:(id)arg3 ;
...
+(void)raiseInvalidRangeUsageErrorForReference:(SCD_Struct_TS322*)arg1 ;
...
+(void)raiseReferenceToEmptyCellErrorForFunctionName:(id)arg1 rangeReference:(SCD_Struct_TS322*)arg2 ;
...
-(id)displayStringWithCalculationEngine:(id)arg1 forTable:(CFUUIDRef)arg2 andCellID:(SCD_Struct_TS288)arg3 ;
-(void)raiseException;

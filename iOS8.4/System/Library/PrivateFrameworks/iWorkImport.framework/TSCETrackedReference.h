...
-(id)initByCopyingASTNodeArray:(TSCEASTNodeArray*)arg1 formulaID:(SCD_Struct_TS324)arg2 ;
-(TSCEASTNodeArray*)ast;
-(SCD_Struct_TS324)formulaID;
-(id)initWithCReference:(SCD_Struct_TS326*)arg1 formulaID:(SCD_Struct_TS324)arg2 ;
-(void)replaceContentsWithContentsOfTrackedReference:(id)arg1 ;
-(void)setFormulaID:(SCD_Struct_TS324)arg1 ;

...
-(id)initWithOutputStream:(id)arg1 checkCrc:(unsigned)arg2 enableDescriptors:(BOOL)arg3 enableToc:(BOOL)arg4 closedCleanly:(BOOL)arg5 archivedVersions:(SCD_Struct_TS257)arg6 ;

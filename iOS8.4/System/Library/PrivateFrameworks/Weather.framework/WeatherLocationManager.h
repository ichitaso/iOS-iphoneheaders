...
@interface WeatherLocationManager : NSObject <CLLocationManagerDelegate> {
	...
	SCD_Struct_We1 _lastLocationCoord;
...
@property (assign,nonatomic) SCD_Struct_We1 lastLocationCoord;                    //@synthesize lastLocationCoord=_lastLocationCoord - In the implementation block
...
-(void)setLastLocationCoord:(SCD_Struct_We1)arg1 ;
...
-(double)_nextPlannedUpdate;
-(double)_lastLocationUpdateTime;
-(SCD_Struct_We1)lastLocationCoord;

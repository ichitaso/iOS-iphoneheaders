...
@property (assign,nonatomic) id<SWSyncServiceConnectionDelegate><SWGenerateTokenConnectionDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
@property (nonatomic,readonly) NSString * PIN;                                                                             //@synthesize PIN=_PIN - In the implementation block
-(void)dealloc;
-(void)setDelegate:(id<SWSyncServiceConnectionDelegate><SWGenerateTokenConnectionDelegate>)arg1 ;
-(id<SWSyncServiceConnectionDelegate><SWGenerateTokenConnectionDelegate>)delegate;
-(NSString *)PIN;

...
-(void)sendMessage:(id)arg1 andStartSessionIfNecessaryForIdentifier:(id)arg2 toDevicesSupportingService:(int)arg3 withTimeout:(long long)arg4 ;
-(void)sendMessage:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)sendMessage:(id)arg1 andCancelOrDeclineInvitiationIfNecessaryForIdentifier:(id)arg2 ;
-(void)sendMessage:(id)arg1 andStartSessionIfNecessaryForIdentifier:(id)arg2 toDevice:(id)arg3 timeout:(long long)arg4 completionHandler:(/*^block*/id)arg5 ;
-(IDSDevice *)deviceWithWaitingSession;
-(void)sendMessage:(id)arg1 andAcceptInvitiationIfNecessaryForIdentifier:(id)arg2 ;
-(void)sendMessage:(id)arg1 forIdentifier:(id)arg2 waitUntilConnected:(BOOL)arg3 ;
...
-(void)_startSession:(id)arg1 withMessage:(id)arg2 identifier:(id)arg3 timeout:(long long)arg4 declineOnError:(BOOL)arg5 ;

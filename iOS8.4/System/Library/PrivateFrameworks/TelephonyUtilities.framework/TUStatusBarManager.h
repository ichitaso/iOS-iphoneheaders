...
@property (assign,getter=isInCallServiceActive,nonatomic) BOOL inCallServiceActive;              //@synthesize inCallServiceActive=_inCallServiceActive - In the implementation block
-(void)dealloc;

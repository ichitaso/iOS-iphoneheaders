...
@interface VKLabelNavJunction : NSObject <VKLabelNavFeature> {
	...
	SCD_Struct_VK493* _labelFeature;
	NSString* _name;
...
@property (nonatomic,readonly) const SCD_Struct_VK448* geoJunction;              //@synthesize geoJunction=_geoJunction - In the implementation block
...
-(id)initWithGEOJunction:(SCD_Struct_VK448*)arg1 routeOffset:(PolylineCoordinate)arg2 tile:(id)arg3 ;
-(id)initWithRoadEdge:(const SCD_Struct_VK451*)arg1 atA:(BOOL)arg2 routeOffset:(PolylineCoordinate)arg3 tile:(id)arg4 ;
...
-(const SCD_Struct_VK448*)geoJunction;

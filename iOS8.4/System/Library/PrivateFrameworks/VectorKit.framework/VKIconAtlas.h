...
-(void)dealloc;
-(id)init;
-(id)artworkForName:(id)arg1 style:(SCD_Struct_VK235*)arg2 contentScale:(double)arg3 size:(long long)arg4 ;
...
-(id)_artworkForBaseImage:(CGImageRef)arg1 additionalImage:(CGImageRef)arg2 cacheKey:(id)arg3 style:(SCD_Struct_VK235*)arg4 contentScale:(double)arg5 ;
@end

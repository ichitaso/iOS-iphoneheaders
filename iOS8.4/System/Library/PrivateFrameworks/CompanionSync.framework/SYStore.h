...
@class NSObject, NSMutableIndexSet, NSMutableDictionary, SYRetryTimer, NSError, NSDictionary, NSString, SYPersistentStore, NSUUID, NMSMessageCenter, SYVectorClock;
...
@property (assign,nonatomic) long long maxBytesInFlight; 

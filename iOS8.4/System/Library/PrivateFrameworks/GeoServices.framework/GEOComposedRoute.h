...
-(void)_addSnappedPolylinePathsForSection:(id)arg1 toPaths:(id)arg2 rects:(SCD_Struct_GE55*)arg3 rectsCount:(unsigned long long)arg4 ;
...
-(BOOL)checkDrivingArrivalForCoordinate:(SCD_Struct_GE15)arg1 coordinateOnRoute:(SCD_Struct_GE15)arg2 routePointIndex:(unsigned)arg3 distanceFromRoute:(double)arg4 arrivalMapRegion:(id)arg5 checkArrivalRadius:(BOOL)arg6 checkDistanceAlongRoute:(BOOL)arg7 isOnRoute:(BOOL)arg8 ;
-(BOOL)isLocationCoordinate:(SCD_Struct_GE15)arg1 withinDistance:(double)arg2 alongRoute:(double)arg3 withTransportType:(int)arg4 ;
...
-(id)getSnappedPathsForVisibleRect:(SCD_Struct_GE55)arg1 rectsToSnap:(SCD_Struct_GE55*)arg2 rectsToSnapCount:(unsigned long long)arg3 observer:(id)arg4 ;
-(BOOL)isSnapping;

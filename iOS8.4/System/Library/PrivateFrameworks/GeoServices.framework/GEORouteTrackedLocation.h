...
-(void)updateWithRouteMatch:(id)arg1 rawLocation:(id)arg2 newStepProgressions:(unsigned long long)arg3 newStepDistanceTraveled:(double)arg4 newStepLastRouteCoord:(PolylineCoordinate)arg5 newStepLastGeoCoord:(SCD_Struct_GE15)arg6 ;

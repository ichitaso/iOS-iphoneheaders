...
-(BOOL)_pointConnects:(const Matrix<float, 2, 1>*)arg1 rect:(const SCD_Struct_GE55*)arg2 to:(const SCD_Struct_GE15*)arg3 ;
-(BOOL)_edgeStart:(const Matrix<float, 2, 1>*)arg1 end:(const Matrix<float, 2, 1>*)arg2 connectsTo:(const SCD_Struct_GE15*)arg3 rect:(const SCD_Struct_GE55*)arg4 ;
-(id)edgeHandler;
-(GEOMapAccess *)map;
@end

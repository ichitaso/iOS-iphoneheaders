...
-(id)_settingsContextForForegroundRestoreWithBackupUDID:(id)arg1 snapshotID:(unsigned long long)arg2 ;
...
-(void)_performToolWithBackupUDID:(id)arg1 snapshotID:(unsigned long long)arg2 block:(/*^block*/id)arg3 ;

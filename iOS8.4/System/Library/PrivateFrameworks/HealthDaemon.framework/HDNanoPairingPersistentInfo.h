...
@property (getter=isActivationFinished,nonatomic,readonly) BOOL activationFinished;              //@synthesize activationFinished=_activationFinished - In the implementation block

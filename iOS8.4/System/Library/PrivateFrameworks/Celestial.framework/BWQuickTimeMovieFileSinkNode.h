...
-(void)_writeBuffer:(opaqueCMSampleBufferRef)arg1 forTrackIndex:(unsigned long long)arg2 ;
-(int)_writeCommonMetadata:(id)arg1 withProperties:(id)arg2 usingWriter:(OpaqueFigMetadataWriterRef)arg3 ;

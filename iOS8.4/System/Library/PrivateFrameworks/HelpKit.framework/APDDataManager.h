...
@property (assign,nonatomic) BOOL searchTermsShouldBeHighlighted;                                //@synthesize searchTermsShouldBeHighlighted=_searchTermsShouldBeHighlighted - In the implementation block
@property (assign,nonatomic) BOOL showGlossaryLinks;                                             //@synthesize showGlossaryLinks=_showGlossaryLinks - In the implementation block
@property (assign,nonatomic) BOOL translucentBar;                                                //@synthesize translucentBar=_translucentBar - In the implementation block
@property (assign,nonatomic) BOOL useRemoteAssetsForLocalHelp;                                   //@synthesize useRemoteAssetsForLocalHelp=_useRemoteAssetsForLocalHelp - In the implementation block
@property (assign,nonatomic) BOOL enableContextMenu;                                             //@synthesize enableContextMenu=_enableContextMenu - In the implementation block
...
@property (assign,getter=isOnline,nonatomic) BOOL online; 

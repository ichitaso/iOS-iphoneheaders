...
-(id)_completion;
-(void)writeMovieFromFiles:(id)arg1 startDate:(id)arg2 location:(id)arg3 outputPath:(id)arg4 transform:(CGAffineTransform)arg5 framesPerSecond:(long long)arg6 completionHandler:(/*^block*/id)arg7 ;

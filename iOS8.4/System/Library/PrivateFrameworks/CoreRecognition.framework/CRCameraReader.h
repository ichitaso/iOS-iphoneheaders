...
@property (assign) BOOL foundNumberFixedSapphire;                                    //@synthesize foundNumberFixedSapphire=_foundNumberFixedSapphire - In the implementation block
@property (assign) BOOL foundNumberFixedSlate;                                       //@synthesize foundNumberFixedSlate=_foundNumberFixedSlate - In the implementation block

...
@class UIView, UITabBarItem, UINavigationItem, NSArray, NSString, NSBundle, UIResponder, UIStoryboard, NSDictionary, UIBarButtonItem, UISearchDisplayController, UIPopoverController, UIScrollView, NSMapTable, NSMutableArray, UITransitionView, UITraitCollection, UIPresentationController, _UILayoutGuide, NSLayoutConstraint, _UIBackdropView, SKUIScrollingSegmentedController, SKUIScrollingTabBarController, SKUIStackedBar, SUStorePageProtocol, SUViewControllerFactory, NSExtensionContext, UINavigationController, UISplitViewController, UITabBarController, UIDropShadowView, UIWindow;

@interface UIViewController : UIResponder <UIViewControllerPresenting, _UITraitEnvironmentInternal, _UIContentContainerInternal, UIFocusContainer, NSCoding, UIAppearanceContainer, UITraitEnvironment, UIContentContainer, _UIViewServiceDeputy, NSExtensionRequestHandling, GKContentRefresh, GKURLHandling> {

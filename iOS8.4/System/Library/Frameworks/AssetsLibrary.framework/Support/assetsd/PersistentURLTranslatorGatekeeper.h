...
-(id)_createPlatformDependentXPCObjectWithBuffer:(void*)arg1 length:(unsigned long long)arg2 ;
-(void)_asynchronousCPLDownloadForAsset:(id)arg1 resourceType:(unsigned long long)arg2 track:(BOOL)arg3 notify:(BOOL)arg4 doneToken:(id)arg5 completionHandler:(/*^block*/id)arg6 ;

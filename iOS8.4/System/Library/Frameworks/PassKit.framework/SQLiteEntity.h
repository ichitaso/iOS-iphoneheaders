...
-(void)getValues:(id*)arg1 forProperties:(id*)arg2 count:(unsigned long long)arg3;
...
+(id)queryWithDatabase:(id)arg1 predicate:(id)arg2 orderingProperties:(id)arg3 orderingDirections:(id)arg4 limit:(long long)arg5 ;
+(long long)countInDatabase:(id)arg1 predicate:(id)arg2 ;

...
-(SCD_Struct_NS19)_minimumRangeOfUnit:(unsigned long long)arg1 ;
-(SCD_Struct_NS19)_maximumRangeOfUnit:(unsigned long long)arg1 ;
-(SCD_Struct_NS19)_rangeOfUnit:(unsigned long long)arg1 inUnit:(unsigned long long)arg2 forAT:(double)arg3 ;

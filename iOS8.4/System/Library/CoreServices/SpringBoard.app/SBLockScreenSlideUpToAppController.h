...
@class UIView, SBLockScreenView, SBLockScreenBounceAnimator, _UIDynamicValueAnimation, SBBounceSettings, SBApplication, LSBestAppSuggestion, NSURL, UIImage, BBObserver, NSMutableArray, SBPasscodeLockDisableAssertion, SBUIPasscodeViewWithLockScreenStyle, SBDisableAppStatusBarAlphaChangesAssertion, NSString, NSSet;

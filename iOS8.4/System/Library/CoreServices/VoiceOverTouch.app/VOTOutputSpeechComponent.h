...
-(void)_insertLongerPausesForSymbol:(id)arg1 withText:(id)arg2 allowPausingAtBoundaries:(BOOL)arg3 onlyApplyWhenFollowedBySpace:(BOOL)arg4 languageCode:(id)arg5 ;

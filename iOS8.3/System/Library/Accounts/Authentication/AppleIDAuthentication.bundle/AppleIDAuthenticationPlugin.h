...
-(char)_isAccountInLilacMode:(id)arg1 store:(id)arg2 ;
...
-(void)_handleCallbackFromPasswordAlert:(CFUserNotificationRef)arg1 withResponse:(unsigned long)arg2 forAccount:(id)arg3 inStore:(id)arg4 isiTunesAccount:(char)arg5 reason:(id)arg6 errorMessage:(id)arg7 resetAuthenticatedOnAlertFailure:(char)arg8 completion:(/*^block*/id)arg9 ;

...
+(id)stringValueForNodeAtPath:(id)arg1 docPtr:(xmlDoc*)arg2 trimStyle:(char)arg3 ;
+(id)stringValuesForNodesAtPath:(id)arg1 docPtr:(xmlDoc*)arg2 trimStyle:(char)arg3 ;
-(void)dealloc;
-(id)description;
-(NSString *)section;

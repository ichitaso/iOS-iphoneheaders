...
-(void)setCenterCoordinate:(SCD_Struct_VK262)arg1 altitude:(double)arg2 yaw:(double)arg3 pitch:(double)arg4 duration:(double)arg5 timingCurve:(/*^block*/id)arg6 completion:(/*^block*/id)arg7 ;
...
-(void)moveTo:(SCD_Struct_VK262)arg1 zoom:(double)arg2 rotation:(double)arg3 tilt:(double)arg4 duration:(double)arg5 timingCurve:(/*^block*/id)arg6 completion:(/*^block*/id)arg7 ;
-(double)zoomForMapRegion:(id)arg1 ;
-(void)showSearchResultAnimationAtCoordinate:(SCD_Struct_VK262)arg1 withZoom:(double)arg2 ;
...
-(void)moveTo:(SCD_Struct_VK262)arg1 height:(double)arg2 useHeight:(char)arg3 zoom:(double)arg4 rotation:(double)arg5 tilt:(double)arg6 duration:(double)arg7 timingCurve:(/*^block*/id)arg8 completion:(/*^block*/id)arg9 ;

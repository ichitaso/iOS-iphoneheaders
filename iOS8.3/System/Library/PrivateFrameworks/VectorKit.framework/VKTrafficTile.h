...
-(char)_buildStartOffset:(float*)arg1 endOffset:(float*)arg2 forLine:(SCD_Struct_VK295*)arg3 forSkeleton:(const Record*)arg4 forRange:(NSRange)arg5 forFlow:(const Flow*)arg6 forPoints:(Matrix<float, 2, 1>*)arg7 ;
-(void)buildIncidentsForDynamic:(id)arg1 withRoadData:(id)arg2 styleSession:(StyleResolutionSession<geo::_retain_ptr<id, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> >*)arg3 ;
-(void)buildTrafficMeshWithRoadData:(id)arg1 dynamicTile:(id)arg2 trafficAccum:(TrafficAccum*)arg3 styleSession:(StyleResolutionSession<geo::_retain_ptr<id, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> >*)arg4 ;
-(void)setDataKey:(const GEOTileKey*)arg1 ;
-(const GEOTileKey*)dataKey;
-(id)initWithKey:(const VKTileKey*)arg1 downloadKey:(const GEOTileKey*)arg2 data:(id)arg3 styleManager:(id)arg4 sharedResources:(id)arg5 contentScale:(float)arg6 device:(Device*)arg7 ;

...
@property (nonatomic,readonly) char isFixedSize;                                                                                                  //@synthesize isFixedSize=_isFixedSize - In the implementation block
...
-(void)addPolygon:(SCD_Struct_VK295*)arg1 building:(SCD_Struct_VK376*)arg2 index:(unsigned)arg3 ofTotal:(unsigned)arg4 hasNonWaterStyle:(char)arg5 accessor:(ResourceAccessor*)arg6 triangulator:(id)arg7 prepareExtrusion:(char)arg8 forRoofStyle:(int)arg9 scaleThreshold:(float)arg10 ;
-(void)prepareForPolygon:(SCD_Struct_VK295*)arg1 building:(SCD_Struct_VK376*)arg2 hasNonWaterStyle:(char)arg3 forRoofStyle:(int)arg4 scaleThreshold:(float)arg5 ;
-(unsigned char)indexForGeoFeatureAttributes:(id)arg1 ;
-(char)canConstructPointyRoofForPolygon:(SCD_Struct_VK295*)arg1 building:(SCD_Struct_VK376*)arg2 buildingModel:(unsigned char)arg3 scaleThreshold:(float)arg4 ;
-(char)addPointyRoofForPolygon:(SCD_Struct_VK295*)arg1 building:(SCD_Struct_VK376*)arg2 buildingModel:(unsigned char)arg3 scaleThreshold:(float)arg4 styleIndex:(float)arg5 ;
-(void)addExtrusionForPolygon:(SCD_Struct_VK295*)arg1 building:(SCD_Struct_VK376*)arg2 index:(unsigned)arg3 ofTotal:(unsigned)arg4 hasNonWaterStyle:(char)arg5 triangulator:(id)arg6 forRoofStyle:(int)arg7 ;

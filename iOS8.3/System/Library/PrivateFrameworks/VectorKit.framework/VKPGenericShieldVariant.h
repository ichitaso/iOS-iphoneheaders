...
@property (nonatomic,readonly) SCD_Struct_VK611* layers; 
...
-(SCD_Struct_VK611)layerAtIndex:(unsigned)arg1 ;
-(void)clearLayers;
-(void)addLayer:(SCD_Struct_VK611)arg1 ;
-(void)setTextBaseline:(float)arg1 ;
-(void)setHasTextBaseline:(char)arg1 ;
-(char)hasTextBaseline;
-(void)setHasFontSize:(char)arg1 ;
-(char)hasFontSize;
-(SCD_Struct_VK611*)layers;
-(void)setLayers:(SCD_Struct_VK611*)arg1 count:(unsigned)arg2 ;

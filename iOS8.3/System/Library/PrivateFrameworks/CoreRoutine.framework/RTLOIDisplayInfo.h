...
@property (nonatomic,readonly) int modeOfTransportation;                //@synthesize modeOfTransportation=_modeOfTransportation - In the implementation block
...
-(char)isEquivalentToDisplayInfo:(id)arg1 ;

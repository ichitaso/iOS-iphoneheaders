...
@interface CUIShapeEffectStack : NSObject {
	...
	SCD_Struct_CU30 colorOverlay;
	BOOL hasInnerGradient;
	SCD_Struct_CU31 innerGradient;
	BOOL hasInnerGlow;
	SCD_Struct_CU32 innerGlow;
	BOOL hasInnerShadow;
	SCD_Struct_CU33 insideShadow;
	BOOL hasOuterGlow;
	SCD_Struct_CU34 outerGlow;
	BOOL hasEngraveShadow;
	SCD_Struct_CU35 engraveShadow;
	BOOL hasExtraShadow;
	SCD_Struct_CU35 extraShadow;
	BOOL hasBevelEmboss;
	SCD_Struct_CU36 emboss;
	float scalefactor;
	int renderStrategy;
...
+(id)gradientWithParameters:(SCD_Struct_CU31*)arg1 inRect:(CGRect)arg2 ;
...
-(SCD_Struct_CU12)effectInsetsWithScale:(float)arg1 ;

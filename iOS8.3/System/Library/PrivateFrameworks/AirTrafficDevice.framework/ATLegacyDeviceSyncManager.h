...
@class ATUserDefaults, ATClientController, ATDeviceDiskUsageProvider, NSObject, NSMutableArray, ATLegacyMessageLink, ATLegacyAssetLink, NSDate, NSMutableDictionary, NSString, ATAsset, ATSession;

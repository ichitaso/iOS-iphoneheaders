...
+(char)_checkFileHeader:(const char*)arg1 length:(unsigned long)arg2 dffVersion:(unsigned short*)arg3 archivedVersions:(SCD_Struct_TS257*)arg4 defaultObjectVersion:(unsigned*)arg5 hasDescriptors:(char*)arg6 hasToc:(char*)arg7 otherDataLength:(unsigned*)arg8 closedCleanly:(char*)arg9 ;
+(id)_newStringFromUtf8DataInStream:(id)arg1 length:(unsigned long)arg2 ;
+(char)readArchivedVersionsFromStream:(id)arg1 versions:(SCD_Struct_TS257*)arg2 error:(id*)arg3 ;

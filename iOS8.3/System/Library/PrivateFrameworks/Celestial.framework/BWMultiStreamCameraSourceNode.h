...
@class BWFigVideoCaptureDevice, NSArray, BWDeferredMetadataCache, NSMutableDictionary, BWNodeOutput, NSObject, NSString, NSDictionary, NSMutableArray;
...
@interface BWMultiStreamCameraSourceNode : BWSourceNode <BWFigCameraSourceNode> {
	...
	SCD_Struct_BW28 _sensorCropDimensions;
	SCD_Struct_BW28 _cropAspectRatio;
	float _lastRequestedZoomFactor;
	float _maxISPZoomFactor;
	unsigned long _videoPixelFormat;
	SCD_Struct_BW28 _videoCaptureDimensions;
	SCD_Struct_BW28 _preferredPreviewDimensions;
...
-(void)setSensorCropDimensions:(SCD_Struct_BW28)arg1 ;
-(void)setCropAspectRatio:(SCD_Struct_BW28)arg1 ;
-(void)setVideoPixelFormat:(unsigned long)arg1 ;
-(void)setVideoStabilizationEnabled:(char)arg1 ;
-(void)setVideoCaptureDimensions:(SCD_Struct_BW28)arg1 ;
-(char)videoStabilizationEnabled;
-(void)setPreferredPreviewDimensions:(SCD_Struct_BW28)arg1 ;
...
-(int)formatIndex;
-(SCD_Struct_BW28)cropAspectRatio;
-(unsigned long)videoPixelFormat;
-(SCD_Struct_BW28)videoCaptureDimensions;
-(SCD_Struct_BW28)preferredPreviewDimensions;

...
@interface BWFigCaptureDeviceSourceNode : BWSourceNode <BWFigCameraSourceNode> {
	...
	SCD_Struct_BW28 _sensorDimensions;
	SCD_Struct_BW28 _minOutputDimensions;
	...
	SCD_Struct_BW28 _streamOutputDimensions;
	SCD_Struct_BW28 _sensorOverscanDimensions;
	char _streamFormatChangeInFlight;
	SCD_Struct_BW28 _streamOutputDimensionsAfterFormatChange;
...
+(int)_indexOfFormatInFormatsArray:(id)arg1 matchingSensorDimensions:(SCD_Struct_BW28)arg2 sensorPixelFormat:(unsigned long)arg3 sensorFormatIndex:(int)arg4 ;
-(float)minFrameRate;
-(float)maxFrameRate;
...
-(SCD_Struct_BW28)outputDimensions;
-(void)dealloc;
...
-(void)setSensorDimensions:(SCD_Struct_BW28)arg1 ;
...
-(void)setOutputDimensions:(SCD_Struct_BW28)arg1 ;
-(SCD_Struct_BW28)minOutputDimensions;
-(void)updateOutputRequirements;
-(SCD_Struct_BW28)sensorOverscanDimensions;
...
-(SCD_Struct_BW28)_maxOutputDimensionsForResolvedSensorFormatIndex;

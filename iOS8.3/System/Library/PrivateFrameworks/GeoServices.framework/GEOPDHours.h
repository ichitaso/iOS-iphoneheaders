...
@property (nonatomic,readonly) SCD_Struct_GE144* timeRanges; 
...
-(SCD_Struct_GE144*)timeRanges;
-(unsigned)timeRangesCount;
-(void)addTimeRange:(SCD_Struct_GE144)arg1 ;
-(void)clearTimeRanges;
-(void)clearDays;
-(int)dayAtIndex:(unsigned)arg1 ;
-(void)addDay:(int)arg1 ;
-(SCD_Struct_GE144)timeRangeAtIndex:(unsigned)arg1 ;
-(void)setTimeRanges:(SCD_Struct_GE144*)arg1 count:(unsigned)arg2 ;

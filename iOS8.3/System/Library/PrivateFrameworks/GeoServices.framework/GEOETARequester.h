...
-(void)_startRequest:(id)arg1 provider:(id)arg2 isRequestUpdate:(char)arg3 connectionProperties:(const SCD_Struct_GE111*)arg4 willSendRequest:(/*^block*/id)arg5 finished:(/*^block*/id)arg6 networkActivity:(/*^block*/id)arg7 error:(/*^block*/id)arg8 ;

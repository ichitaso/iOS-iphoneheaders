...
@class GEOPDPlace, GEOPlace, NSMapTable, GEOPDMultiLocalizedString, NSString, NSData, GEOMapRegion, GEOAddress, NSDictionary, NSArray, NSDate, GEOMapItemClientAttributes, GEOPDFlyover, NSURL, GEOMapItemPlaceAttribution, GEOMapItemPhotosAttribution, GEOMapItemReviewsAttribution, GEOFeatureStyleAttributes, GEOPDBusinessClaim;

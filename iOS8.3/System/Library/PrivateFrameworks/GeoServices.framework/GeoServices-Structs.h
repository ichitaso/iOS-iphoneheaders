...
typedef struct {
	...
	unsigned geotagHorizontalAccuracy : 1;
	unsigned geotagTimestamp : 1;
} SCD_Struct_GE4;
...
typedef struct {
	unsigned distance : 1;
	unsigned historicalDuration : 1;
	unsigned originalDuration : 1;
	unsigned canNavigate : 1;
} SCD_Struct_GE49;
...
typedef struct {
	SCD_Struct_GE15 origin;
	SCD_Struct_GE15 size;
} SCD_Struct_GE55;

typedef struct {
	int field1;
	SCD_Struct_GE15 field2;
	double field3;
	double field4;
	double field5;
	double field6;
...
typedef struct {
	unsigned sessionID : 1;
	unsigned durationInOldState : 1;
	unsigned newCoverage : 1;
	unsigned oldCoverage : 1;
	unsigned sessionRelativeTimestamp : 1;
	unsigned tileSetStateType : 1;
} SCD_Struct_GE62;
...
typedef struct {
	...
	SCD_Struct_GE93 field2;
} SCD_Struct_GE96;

typedef struct {
	SCD_Struct_GE92 field1;
	unsigned field2;
	unsigned field3;
	int field4;
	int field5;
	...
	= field10;
	SCD_Struct_GE94 field11;
	SCD_Struct_GE95) field12;
	/*function pointer*/void* field13;
	SCD_Struct_GE96 field14;
...
typedef struct {
	...
	char field7;
	char field8;
	SCD_Struct_GE135 field9[16];
} SCD_Struct_GE136;

typedef struct {
	SCD_Struct_GE128 field1;

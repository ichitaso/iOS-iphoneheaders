...
-(PolylineCoordinate)_findRouteCoordinateWithOffset:(float)arg1 aPos:(const Matrix<float, 2, 1>*)arg2 aCoord:(const PolylineCoordinate*)arg3 bCoord:(const PolylineCoordinate*)arg4 pointOnSegment:(const Matrix<float, 2, 1>*)arg5 bounds:(const SCD_Struct_GE55*)arg6 ;
...
-(void)_addSnappedPolylinePathsForSection:(id)arg1 toPaths:(id)arg2 rects:(SCD_Struct_GE55*)arg3 rectsCount:(unsigned long)arg4 ;
...
-(SCD_Struct_GE70)maneuverDisplayEndpointsAtIndex:(unsigned long)arg1 ;
...
-(id)getSnappedPathsForVisibleRect:(SCD_Struct_GE55)arg1 rectsToSnap:(SCD_Struct_GE55*)arg2 rectsToSnapCount:(unsigned long)arg3 observer:(id)arg4 ;
-(char)isSnapping;

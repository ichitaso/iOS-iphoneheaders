...
-(void)clearTileSets;
-(SCD_Struct_GE86)tileSetAtIndex:(unsigned)arg1 ;
...
-(SCD_Struct_GE85)regionalResourceIndexAtIndex:(unsigned)arg1 ;
...
-(void)setTileSets:(SCD_Struct_GE86*)arg1 count:(unsigned)arg2 ;
...
-(void)setRegionalResourceIndexs:(SCD_Struct_GE85*)arg1 count:(unsigned)arg2 ;
-(unsigned*)xmlIndexs;

...
-(void)getBytes:(void*)arg1 bytesPerRow:(unsigned)arg2 bytesPerImage:(unsigned)arg3 fromRegion:(SCD_Struct_MT14)arg4 mipmapLevel:(unsigned)arg5 slice:(unsigned)arg6 ;
-(void)replaceRegion:(SCD_Struct_MT14)arg1 mipmapLevel:(unsigned)arg2 slice:(unsigned)arg3 withBytes:(const void*)arg4 bytesPerRow:(unsigned)arg5 bytesPerImage:(unsigned)arg6 ;

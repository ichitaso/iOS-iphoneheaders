...
-(char)_canPlayCachedAssetAtPath:(id)arg1 ;
-(id)_newAVAssetForContext:(id)arg1 ;
-(id)_assetForExistingDownloadSession:(id)arg1 context:(id)arg2 downloadSessionID:(id)arg3 wantingHighQuality:(char)arg4 returningShouldAttemptFurtherLoad:(out char*)arg5 ;
...
-(char)_downloadExistsWithSessionIdentifier:(id)arg1 ;

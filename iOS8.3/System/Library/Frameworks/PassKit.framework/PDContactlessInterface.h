...
@interface PDContactlessInterface : NSObject <CLLocationManagerDelegate, NFCardEmulationDelegate, PDDistributedNotificationConsumer> {
	...
	char _cardEmulationStarted;
	char _fieldDetectionStarted;
	char _delayingExitForLocationUpdates;
	char _isInField;
...
@property (nonatomic,readonly) char isDetectingField; 
@property (nonatomic,readonly) char isInField;                                         //@synthesize isInField=_isInField - In the implementation block
...
-(char)pendingLocationLookupForTransaction:(id)arg1 ;
-(PDSecureElement *)secureElement;
-(void)preheatForTransactionEvent;
-(char)_contactlessInterfaceAccessIsRestricted;

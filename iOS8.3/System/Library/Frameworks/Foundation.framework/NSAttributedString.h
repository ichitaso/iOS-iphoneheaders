...
-(char)getRange:(NSRange*)arg1 ofAttribute:(id)arg2 ;
-(char)getRange:(NSRange*)arg1 ofAttribute:(id)arg2 withValue:(id)arg3 ;
-(CGSize)pkui_sizeThatFits:(CGSize)arg1 withNumberOfLines:(unsigned)arg2 ;
-(CGSize)pkui_sizeThatFits:(CGSize)arg1 withNumberOfLines:(unsigned)arg2 forceWordWrap:(char)arg3 ;

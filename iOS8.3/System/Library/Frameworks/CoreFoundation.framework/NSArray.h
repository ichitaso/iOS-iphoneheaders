...
-(id)sbf_mapNoNulls:(/*^block*/id)arg1 ;
-(id)sbf_first:(unsigned)arg1 ;
-(id)sbf_map:(/*^block*/id)arg1 ;
-(id)sbf_filter:(/*^block*/id)arg1 ;
-(void)sbf_each:(/*^block*/id)arg1 ;
-(id)sbf_foldWithInitialValue:(id)arg1 block:(/*^block*/id)arg2 ;
-(id)sbf_firstObjectOfClass:(Class)arg1 ;
-(id)sbf_firstObjectOfClassNamed:(id)arg1 ;
-(id)sbf_reverse;
-(id)sbf_firstObjectPassingTest:(/*^block*/id)arg1 ;
-(void)addUniqueObjectsOfClass:(Class)arg1 toArray:(id)arg2 ;
-(id)objectOfClass:(Class)arg1 ;
-(id)prs_mapAndFilterObjectsUsingBlock:(/*^block*/id)arg1 ;
-(id)prs_numberAtIndex:(unsigned)arg1 ;
-(id)prs_stringAtIndex:(unsigned)arg1 ;
-(id)prs_dictionaryAtIndex:(unsigned)arg1 ;
-(id)prs_arrayAtIndex:(unsigned)arg1 ;
-(id)prs_mapObjectsUsingBlock:(/*^block*/id)arg1 ;
-(id)prs_filterObjectsUsingBlock:(/*^block*/id)arg1 ;
-(id)sortedArrayByVisuallySortingElements;

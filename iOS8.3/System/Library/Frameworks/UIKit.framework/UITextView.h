...
#import <UIKit/SBSearchText.h>

@protocol UITextInputTokenizer;
@class NSString, NSAttributedString, NSTextStorage, NSTextContainer, NSLayoutManager, _UITextContainerView, UITextInputController, UITextInteractionAssistant, UITextInputTraits, UIAutoscroll, _UITextViewRestorableScrollPosition, UILabel, UIView, _UISiriStreamingManager, _UICharacterStreamingManager, NSDictionary, UIFont, MPUTextContainerContentSizeUpdater, UIColor, UIImage, UITextRange, UITextPosition;

@interface UITextView : UIScrollView <UITextLinkInteraction, UITextInputControllerDelegate, UITextAutoscrolling, UIKeyboardInput, UITextInputTraits_Private, _UIMultilineTextContentSizing, _UILayoutBaselineUpdating, UITextInput, ABText, MPUAutoupdatingTextContainer, SBSearchText> {

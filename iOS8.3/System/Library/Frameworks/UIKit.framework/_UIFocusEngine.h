...
-(CGSize)_vectorForFocusHeading:(unsigned)arg1 ;
-(id)_focusedView;
-(id)_bestFocusCandidateForFocusHeading:(unsigned)arg1 currentFocusView:(id)arg2 direction:(CGSize)arg3 inView:(id)arg4 ;
...
-(char)_sendsFocusDirection;
-(char)_moveFocusAlongVector:(CGSize)arg1 ;

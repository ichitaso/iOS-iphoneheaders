...
+(float)labelSpacingDerivedFromHIBaselineOffset:(float)arg1 fromBottomLineBaselineOfFont:(id)arg2 toTopLineBaselineOfFont:(id)arg3 ;
+(float)labelSpacingDerivedFromHIBaselineOffset:(float)arg1 fromFont:(id)arg2 ;
...
-(float)sb_yPositionForLabelWithContainerBounds:(CGRect)arg1 baselineOffset:(float)arg2 font:(id)arg3 ;
-(float)sb_yPositionForLayoutAfterLabel:(id)arg1 baselineOffset:(float)arg2 ;
-(float)sb_yPositionForLabelWithContainerBounds:(CGRect)arg1 lineHeight:(float)arg2 baselineOffset:(float)arg3 font:(id)arg4 ;

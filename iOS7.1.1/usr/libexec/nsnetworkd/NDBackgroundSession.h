...
#import <nsnetworkd/NSURLSessionDataDelegate.h>
#import <nsnetworkd/NSURLSessionDownloadDelegate.h>
...
-(void)wakeUpClient;
-(/*^block*/ id)invalidateReply;
-(void)setInvalidateReply:(/*^block*/ id)arg1 ;
-(BOOL)clientIsActive;

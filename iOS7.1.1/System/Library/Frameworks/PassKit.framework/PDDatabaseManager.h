...
-(BOOL)passExistsWithPassStyle:(unsigned)arg1 ;
...
-(id)candidatePassesOfStyle:(unsigned)arg1 activatingBetweenStart:(id)arg2 end:(id)arg3 ;
...
-(BOOL)hasCandidatePassesOfStyle:(unsigned)arg1 ;
-(id)unlocatedCandidatePassesOfStyle:(unsigned)arg1 activatingBetweenStart:(id)arg2 end:(id)arg3 ;
-(id)locatedCandidatePassesOfStyle:(unsigned)arg1 activatingBetweenStart:(id)arg2 end:(id)arg3 ;
-(id)locatedDatelessCandidatePassesOfStyle:(unsigned)arg1 ;
-(id)locationsByUniqueIDInBoundingBoxOfRegion:(id)arg1 ;
-(id)_predicateForStyle:(unsigned)arg1 ;
...
-(id)_candidatePassesOfStyle:(unsigned)arg1 activatingBetweenStart:(id)arg2 end:(id)arg3 furtherPredicate:(id)arg4 ;
-(id)_unlocatedPredicate;
-(id)_locatedCandidatePassesOfStyle:(unsigned)arg1 matchingFurtherPredicate:(id)arg2 ;
...
-(id)locatedCandidatePassesOfStyle:(unsigned)arg1 ;
-(id)locatedCandidatePassesOfStyle:(unsigned)arg1 filteringOutPasses:(id)arg2 ;

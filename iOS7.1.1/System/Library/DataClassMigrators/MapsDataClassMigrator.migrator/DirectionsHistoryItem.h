...
@interface DirectionsHistoryItem : PersistentDirectionsHistoryItem <HistoryItem, SyncingHistoryItem, HistoryPersistentItem>
...
-(int)_transportTypeForDirectionsMode:(long long)arg1 ;
-(id)initWithStartSearchResult:(id)arg1 endSearchResult:(id)arg2 directionsMode:(long long)arg3 timestamp:(double)arg4 ;

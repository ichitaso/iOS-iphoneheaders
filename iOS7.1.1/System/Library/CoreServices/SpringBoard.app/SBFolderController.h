...
@class SBIconViewMap, SBFolderView, NSTimer, NSMapTable, SBIconAnimator, SBFolder, _UILegibilitySettings, SBFolderControllerAnimationContext, SBIcon, SBFolderContext, NSArray;

...
@class SBWindow, UIView, UIStatusBar, SBAppSliderController, SBAppSliderWindowController, SBApplication, NSString, SBDismissOnlyAlertItem, NSMutableDictionary, SBAnimationStepper, SBWorkspaceEventQueueLockAssertion, SBSwitchAppGestureView, NSMutableArray, NSArray, NSMutableSet;

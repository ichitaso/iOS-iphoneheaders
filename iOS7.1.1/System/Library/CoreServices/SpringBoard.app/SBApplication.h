...
-(void)validateSystemProvisioningEntitlements:(SCD_Struct_SB8*)arg1 ;
...
-(id)fileSnapshotForImageInfo:(id)arg1 downscaled:(BOOL)arg2 originalOrientation:(out int*)arg3 currentOrientation:(out int*)arg4 ;
...
-(id)_snapshotImageInfoForScreen:(id)arg1 named:(id)arg2 downscaled:(BOOL)arg3 launchingOrientation:(int)arg4 ;
-(id)_snapshotImageWithImageName:(id)arg1 forScreen:(id)arg2 downscaled:(BOOL)arg3 launchingOrientation:(int)arg4 originalOrientation:(int*)arg5 currentOrientation:(int*)arg6 ;
...
-(id)_snapshotImageInfoForScreen:(id)arg1 downscaled:(BOOL)arg2 launchingOrientation:(int)arg3 ;

...
@class NSSet, SBIconModel, SBIconContentView, BBObserver, NSMutableSet, SBRootFolderController, SBFolder, SBIcon, SBLeafIcon, NSMutableArray, UITouch, NSTimer, SBIconColorSettings, _UILegibilitySettings, NSIndexPath;

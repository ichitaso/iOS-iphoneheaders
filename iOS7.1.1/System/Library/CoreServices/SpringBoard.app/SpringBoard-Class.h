...
-(void)endLaunchTest;
-(void)applicationOpenURL:(id)arg1 withApplication:(id)arg2 sender:(id)arg3 publicURLsOnly:(BOOL)arg4 animating:(BOOL)arg5 needsPermission:(BOOL)arg6 activationContext:(id)arg7 activationHandler:(/*^block*/ id)arg8 ;
...
-(void)_openURLCore:(id)arg1 display:(id)arg2 animating:(BOOL)arg3 sender:(id)arg4 activationContext:(id)arg5 activationHandler:(/*^block*/ id)arg6 ;

...
@interface SCATModernMenuGestureFingersSheet : SCATModernMenuGesturesSheetBase {
	...
	<SCATMenuFingerItemsViewDelegate>* _delegate;

}

@property (assign,nonatomic) <SCATMenuFingerItemsViewDelegate> * delegate;              //@synthesize delegate=_delegate - In the implementation block

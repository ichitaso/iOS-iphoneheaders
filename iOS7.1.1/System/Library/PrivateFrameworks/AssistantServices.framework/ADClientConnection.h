...
@interface ADClientConnection : NSObject <ADHandsFreeStateChangedObserver, ADCommandCenterClient, ADCommandCenterRequestDelegate, ADCommandCenterSpeechDelegate, AFClientService> {

	<AFClientServiceDelegate>* _serviceDelegate;
...
-(void)adShouldSpeakStateDidChange:(BOOL)arg1 ;

...
-(void)migrate:(id)arg1 params:(id)arg2 ;
...
-(id)createActivationLockBypassCode:(id)arg1 params:(id)arg2 ;
-(id)storeActivationRecord:(id)arg1 params:(id)arg2 ;
...
-(void)stashBlacklistURLStrings:(id)arg1 params:(id)arg2 ;
-(void)unstashBlacklistURLStrings:(id)arg1 params:(id)arg2 ;
-(void)stashWhitelistURLStrings:(id)arg1 params:(id)arg2 ;
-(void)unstashWhitelistURLStrings:(id)arg1 params:(id)arg2 ;
-(id)removeBlacklistURLString:(id)arg1 params:(id)arg2 ;
-(void)checkIn:(id)arg1 params:(id)arg2 ;
-(void)checkCarrierProfile:(id)arg1 params:(id)arg2 ;
-(void)deviceUnlocked:(id)arg1 params:(id)arg2 ;
-(void)performBootTimeChecks:(id)arg1 params:(id)arg2 ;
-(void)shutDown:(id)arg1 params:(id)arg2 ;
-(void)flush:(id)arg1 params:(id)arg2 ;
-(id)allowedOpenInAppBundleIDs:(id)arg1 params:(id)arg2 auditToken:(SCD_Struct_MC0*)arg3 ;
-(id)mayShareToMessages:(id)arg1 params:(id)arg2 auditToken:(SCD_Struct_MC0*)arg3 ;
...
-(void)powerAssertionAsserted:(id)arg1 ;
-(void)powerAssertionDeasserted:(id)arg1 ;

...
-(id)deliveryGroups;
-(bool)p_canMoveBuildChunks:(id)arg1 toIndex:(unsigned long long)arg2 ;
...
-(bool)canMoveBuildChunk:(id)arg1 toIndex:(unsigned long long)arg2 inDeliveryGroup:(unsigned long long)arg3 ;

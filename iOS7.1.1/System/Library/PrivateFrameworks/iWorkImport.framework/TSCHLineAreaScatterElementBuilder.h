...
-(unsigned long long)countOfPointsForSeries:(id)arg1 forGroups:(id)arg2 forBodyLayout:(id)arg3 outElementSize:(CGSize*)arg4 outClipRect:(CGRect*)arg5 outUnitSymbolPath:(const CGPath*)arg6 outNewTransformArray:(CGAffineTransform*)arg7 ;
...
-(void)p_addCurvedTopStroke:(SCD_Struct_TS457*)arg1 toPath:(CGPathRef)arg2 withPointsArray:(SCD_Struct_TS456*)arg3 withCount:(unsigned long long)arg4 ;
...
-(SCD_Struct_TS456*)p_createPointArrayForSeries:(id)arg1 inAreaFrame:(CGRect)arg2 valueStart:(unsigned long long)arg3 valueEnd:(unsigned long long)arg4 cullBadPoints:(bool)arg5 outCount:(unsigned long long*)arg6 ;

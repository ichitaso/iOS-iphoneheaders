...
typedef struct {
	SCD_Struct_TS267 mTopLeft;
	SCD_Struct_TS267 mBottomRight;
} SCD_Struct_TS268;
...
typedef struct {
	SCD_Struct_TS268 range;
	__CFUUID tableID;
} SCD_Struct_TS270;

typedef struct {
	__CFUUID mTableID;
	SCD_Struct_TS268 mOldTableSize;
	SCD_Struct_TS268 mNewTableSize;
} SCD_Struct_TS271;

typedef struct {
	__CFUUID mTableID;
	SCD_Struct_TS268 mMergedRange;
} SCD_Struct_TS272;

typedef struct {
	SCD_Struct_TS270 mFromReference;
	SCD_Struct_TS270 mToReference;
} SCD_Struct_TS273;

typedef union {
	TSCETectonicShift* mTectonicShift;
	SCD_Struct_TS269 mRemapSortMappingInfo;
	SCD_Struct_TS273 mRangeMovedInfo;
	__CFUUID mDeletedOwnerID;
	SCD_Struct_TS271 mTableResizedInfo;
	SCD_Struct_TS272 mCellMergedInfo;
} SCD_Union_TS274;
...
typedef struct {
	...
	= field3;
	CFUUID field4;
	SCD_Struct_TS270 field5;
	SCD_Struct_TS286 field6;
	_ field7;
	_ field8;
	SCD_Struct_TS288) field9;
} SCD_Struct_TS289;
...
typedef struct {
	SCD_Struct_TS267 coordinate;
	__CFUUID tableID;
} SCD_Struct_TS334;

typedef struct {
	SCD_Struct_TS270 rangeReference;
	int rangeContext;
} SCD_Struct_TS335;
...
typedef struct {
	...
	SCD_Struct_TS334 cellReference;
	SCD_Struct_TS270 rangeReference;
	SCD_Struct_TS335 spanningRangeReference;
	__CFUUID) tableID;
} SCD_Struct_TS336;
...
typedef struct {
	...
	CFUUID field4;
	SCD_Struct_TS270 field5;
	SCD_Struct_TS334 field6;
	_ field7;
	_ field8;
	SCD_Struct_TS335) field9;
} SCD_Struct_TS337;
...
typedef struct {
	SCD_Struct_TS249 topLeft;
	SCD_Struct_TS249 bottomRight;
} SCD_Struct_TS485;
...
typedef struct {
	SCD_Struct_TS267 origin;
	SCD_Struct_TS499 size;
} SCD_Struct_TS500;
...
typedef struct {
	SCD_Struct_TS50 field1;
	2 field2;
	SCD_Struct_TS50 field3;
	2 field4;
} SCD_Struct_TS503;
...
typedef struct {
	SCD_Struct_TS507 topLeft;
	SCD_Struct_TS507 bottomRight;
} SCD_Struct_TS508;
...
typedef struct _tree_const_iterator<TSTMergeRangeElem, const std::__1::__tree_node<TSTMergeRangeElem, void *> *, long> {
	__tree_node<TSTMergeRangeElem, void *> __ptr_;
} tree_const_iterator<TSTMergeRangeElem, const std::__1::__tree_node<TSTMergeRangeElem, void *> *, long>;
...
typedef struct {
	...
	NSDate* date;
	NSString* string;
	SCD_Struct_TS552 reference;
	SCD_Struct_TS551) duration;
} SCD_Struct_TS553;
...
typedef struct {
	...
	id field5;
	id field6;
	SCD_Struct_TS551 field7;
	SCD_Struct_TS552) field8;
} SCD_Struct_TS554;
...
typedef struct {
	...
	9 field7;
	UpdatableValue<unsigned int> field8;
	UpdatableValue<unsigned int> field9;
	SCD_Struct_TS568 field10;
	9) field11;
} SCD_Struct_TS569;
...
typedef struct {
	...
	SCD_Struct_TS590 parData;
	SCD_Struct_TS590 parStartData;
	SCD_Struct_TS590 parBidiData;
} SCD_Struct_TS591;
...
typedef struct _compressed_pair<unsigned long, std::__1::__map_value_compare<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter>, std::__1::less<unsigned long>, true> > {
	unsigned long long __first_;
} compressed_pair<unsigned long, std::__1::__map_value_compare<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter>, std::__1::less<unsigned long>, true> >;

typedef struct _compressed_pair<std::__1::__tree_end_node<std::__1::__tree_node_base<void *> *>, std::__1::allocator<std::__1::__tree_node<std::__1::pair<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter> >, void *> > > {
	tree_end_node<std::__1::__tree_node_base<void *> *> __first_;
} compressed_pair<std::__1::__tree_end_node<std::__1::__tree_node_base<void *> *>, std::__1::allocator<std::__1::__tree_node<std::__1::pair<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter> >, void *> > >;

typedef struct _tree<std::__1::pair<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter> >, std::__1::__map_value_compare<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter>, std::__1::less<unsigned long>, true>, std::__1::allocator<std::__1::pair<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter> > > > {
	__tree_node<std::__1::pair<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter> >, void *> __begin_node_;
	compressed_pair<std::__1::__tree_end_node<std::__1::__tree_node_base<void *> *>, std::__1::allocator<std::__1::__tree_node<std::__1::pair<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter> >, void *> > > __pair1_;
	compressed_pair<unsigned long, std::__1::__map_value_compare<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter>, std::__1::less<unsigned long>, true> > __pair3_;
} tree<std::__1::pair<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter> >, std::__1::__map_value_compare<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter>, std::__1::less<unsigned long>, true>, std::__1::allocator<std::__1::pair<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter> > > >;
...
typedef struct map<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter>, std::__1::less<unsigned long>, std::__1::allocator<std::__1::pair<const unsigned long, boost::shared_ptr<TSWPParagraphTypesetter> > > > {
	tree<std::__1::pair<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter> >, std::__1::__map_value_compare<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter>, std::__1::less<unsigned long>, true>, std::__1::allocator<std::__1::pair<unsigned long, boost::shared_ptr<TSWPParagraphTypesetter> > > > __tree_;
...
typedef struct {
	SCD_Struct_TS47 field1;
	9 field2;
	SCD_Struct_TS47 field3;
	3 field4;
	SCD_Struct_TS48 field5;
	3 field6;
...
typedef struct _compressed_pair<unsigned long, std::__1::__map_value_compare<unsigned long, TPPageLayout *, std::__1::less<unsigned long>, true> > {
	unsigned long long __first_;
} compressed_pair<unsigned long, std::__1::__map_value_compare<unsigned long, TPPageLayout *, std::__1::less<unsigned long>, true> >;

typedef struct _compressed_pair<std::__1::__tree_end_node<std::__1::__tree_node_base<void *> *>, std::__1::allocator<std::__1::__tree_node<std::__1::pair<unsigned long, TPPageLayout *>, void *> > > {
	tree_end_node<std::__1::__tree_node_base<void *> *> __first_;
} compressed_pair<std::__1::__tree_end_node<std::__1::__tree_node_base<void *> *>, std::__1::allocator<std::__1::__tree_node<std::__1::pair<unsigned long, TPPageLayout *>, void *> > >;

typedef struct _tree<std::__1::pair<unsigned long, TPPageLayout *>, std::__1::__map_value_compare<unsigned long, TPPageLayout *, std::__1::less<unsigned long>, true>, std::__1::allocator<std::__1::pair<unsigned long, TPPageLayout *> > > {
	__tree_node<std::__1::pair<unsigned long, TPPageLayout *>, void *> __begin_node_;
	compressed_pair<std::__1::__tree_end_node<std::__1::__tree_node_base<void *> *>, std::__1::allocator<std::__1::__tree_node<std::__1::pair<unsigned long, TPPageLayout *>, void *> > > __pair1_;
	compressed_pair<unsigned long, std::__1::__map_value_compare<unsigned long, TPPageLayout *, std::__1::less<unsigned long>, true> > __pair3_;
} tree<std::__1::pair<unsigned long, TPPageLayout *>, std::__1::__map_value_compare<unsigned long, TPPageLayout *, std::__1::less<unsigned long>, true>, std::__1::allocator<std::__1::pair<unsigned long, TPPageLayout *> > >;
...
typedef struct multimap<unsigned long, TPPageLayout *, std::__1::less<unsigned long>, std::__1::allocator<std::__1::pair<const unsigned long, TPPageLayout *> > > {
	tree<std::__1::pair<unsigned long, TPPageLayout *>, std::__1::__map_value_compare<unsigned long, TPPageLayout *, std::__1::less<unsigned long>, true>, std::__1::allocator<std::__1::pair<unsigned long, TPPageLayout *> > > __tree_;

...
@interface SLTencentWeiboMigrationPasswordViewController : UITableViewController <UITableViewDataSource, UITableViewDelegate> {
	...
	<SLTencentWeiboMigrationPasswordViewControllerDelegate>* _delegate;
	NSString* _username;
	NSString* _password;

}

@property (assign,nonatomic,__weak) <SLTencentWeiboMigrationPasswordViewControllerDelegate> * delegate;              //@synthesize delegate=_delegate - In the implementation block

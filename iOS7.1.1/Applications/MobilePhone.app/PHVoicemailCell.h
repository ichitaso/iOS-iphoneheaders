...
@class UIImageView, UILabel, UIDateLabel, UIButton, PHVoicemailSlider, NSMutableArray, NSLayoutConstraint, UIGestureRecognizer, PHCellContentView, UIView, VMVoicemail, UIActionSheet, NSArray, NSString, NSDate;

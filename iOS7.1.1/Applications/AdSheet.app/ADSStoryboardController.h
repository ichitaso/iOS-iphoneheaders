...
@class ADSAdSpaceController, ADSStoryboardActionViewController, NSURL, ADSStoryboardWebView, ADCountdownButton, UIProgressView, UIPopoverController, NSTimer, UIImageView, ADSAdImpressionController, ADQuicklookPreview, ADSCreativeView, ADSAdImpression;

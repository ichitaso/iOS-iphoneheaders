...
@property (assign,nonatomic) BOOL wantsBarsHidden;                                                           //@synthesize wantsBarsHidden=_wantsBarsHidden - In the implementation block
...
-(void)setWantsBarsHidden:(BOOL)arg1 ;
...
-(void)updateBarHidingDimmingViewAnimated:(BOOL)arg1 ;
...
-(BOOL)_shouldPrefetchMatch:(id)arg1 matchLength:(unsigned)arg2 ;

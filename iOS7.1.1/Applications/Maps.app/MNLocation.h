...
+(id)locationWithRawLocation:(id)arg1 coordinate:(SCD_Struct_Si13)arg2 course:(double)arg3 ;
...
-(id)initWithRawLocation:(id)arg1 coordinate:(SCD_Struct_Si13)arg2 course:(double)arg3 ;

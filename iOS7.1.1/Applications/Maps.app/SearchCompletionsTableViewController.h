...
@interface SearchCompletionsTableViewController : UITableViewController <MKSearchCompleterDelegate, ExtendedTableViewDelegate, SearchBarSearchManagerDelegate> {
	...
	float _tableViewCellHeight;
	SearchInfo* _refinementResults;
	UIView* _noContentView;

}

@property (assign,nonatomic,__weak) <SearchCompletionsTableViewControllerDelegate> * delegate;              //@synthesize delegate=_delegate - In the implementation block
...
@property (assign,nonatomic) float tableViewCellHeight;                                                     //@synthesize tableViewCellHeight=_tableViewCellHeight - In the implementation block
...
-(void)setTableViewCellHeight:(float)arg1 ;

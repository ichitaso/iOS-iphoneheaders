...
@class SearchFieldItem, UIBarButtonItem, SearchCompletionsTableViewController, SearchResult, UISegmentedControl, DirectionsFieldsView, UIView, UINavigationController, TransitAppSelectionController, BlurView, PopoverRevealViewController;
...
@property (assign,nonatomic,__weak) <DirectionsSearchViewControllerDelegate> * delegate;                    //@synthesize delegate=_delegate - In the implementation block

...
@property (assign,nonatomic,__weak) <MNNavigationModeControllerDelegate> * delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(void)_endNavModeAnimated:(BOOL)arg1 isNavigationEnding:(BOOL)arg2 destination:(int)arg3 ;
...
-(void)directionsSessionDidFailToRequestRoute:(id)arg1 problemDetails:(SCD_Struct_MN24*)arg2 ;

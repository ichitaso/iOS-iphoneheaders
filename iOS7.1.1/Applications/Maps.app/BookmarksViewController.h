...
@property (assign,nonatomic,__weak) <CollectionsViewControllerDelegate> * collectionsViewControllerDelegate;              //@synthesize collectionsViewControllerDelegate=_collectionsViewControllerDelegate - In the implementation block

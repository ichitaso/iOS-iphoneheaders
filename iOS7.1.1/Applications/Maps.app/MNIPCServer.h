...
@property (assign,nonatomic,__weak) <MNLockScreenLayerSource> * lockScreenLayerSource;                            //@synthesize lockScreenLayerSource=_lockScreenLayerSource - In the implementation block
@property (assign,nonatomic,__weak) <MNExternalGuidanceSource> * externalGuidanceSource;                          //@synthesize externalGuidanceSource=_externalGuidanceSource - In the implementation block
@property (assign,nonatomic,__weak) <MNBackgroundNavigationDelegate> * backgroundNavigationDelegate;              //@synthesize backgroundNavigationDelegate=_backgroundNavigationDelegate - In the implementation block

...
@property (assign,nonatomic,__weak) <CollectionsTableViewControllerDelegate> * collectionsTableViewControllerDelegate;              //@synthesize collectionsTableViewControllerDelegate=_collectionsTableViewControllerDelegate - In the implementation block

...
@property (assign,nonatomic,__weak) <MUPlaceCardReviewsControllerDelegate> * reviewsControllerDelegate;              //@synthesize reviewsControllerDelegate=_reviewsControllerDelegate - In the implementation block

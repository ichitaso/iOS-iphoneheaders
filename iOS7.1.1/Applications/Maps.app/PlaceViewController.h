...
@property (assign,nonatomic,__weak) <PlaceViewControllerDelegate> * placeViewControllerDelegate;              //@synthesize placeViewControllerDelegate=_placeViewControllerDelegate - In the implementation block
...
-(BOOL)showNearbyApps;
-(void)_findNearbyAppsAtCoordinate:(SCD_Struct_Si13)arg1 ;

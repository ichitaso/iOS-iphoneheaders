...
-(void)_recordLocationEvent:(int)arg1 coordinate:(SCD_Struct_Si13)arg2 rawCoordinate:(SCD_Struct_Si13)arg3 timestamp:(double)arg4 horizontalAccuracy:(double)arg5 verticalAccuracy:(double)arg6 altitude:(double)arg7 speed:(double)arg8 speedAccuracy:(double)arg9 course:(double)arg10 rawCourse:(double)arg11 type:(int)arg12 courseAccuracy:(double)arg13 correctedCoordinate:(SCD_Struct_Si13)arg14 correctedCourse:(double)arg15 matchType:(int)arg16 motionType:(int)arg17 motionConfidence:(int)arg18 motionExitType:(int)arg19 activeTransportType:(int)arg20 ;
...
-(void)recordSimulatedCoordinate:(SCD_Struct_Si13)arg1 course:(double)arg2 altitude:(double)arg3 speed:(double)arg4 timestamp:(double)arg5 activeTransportType:(int)arg6 ;
...
-(void)recordLikelyRouteRequest:(id)arg1 response:(id)arg2 ;

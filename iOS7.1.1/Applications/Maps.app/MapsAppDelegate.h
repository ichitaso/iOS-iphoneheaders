...
@class UIWindow, MapNavigationController, MapsMainModeController, MapsURLHandler, UINavigationController, MapsDebugController, EasyCallbackAlertView, MainChromeViewController, NSHashTable, StarkDisplayController, NSDate, NSTimer, NSMutableSet, BKSProcessAssertion, MapsLaunchHandler, LightLevelController, NSArray;

@interface MapsAppDelegate : UIResponder <UIApplicationTestingDelegate, StarkDisplayControllerDelegate, UIApplicationDelegate, UIApplicationDelegatePrivate, UINavigationControllerDelegate, MNBackgroundNavigationDelegate, UIAlertViewDelegate, AFContextProvider> {
...
-(void)jumpToCoords:(SCD_Struct_Ma29)arg1 pitch:(double)arg2 yaw:(double)arg3 ;
...
-(id)shieldArtworkForType:(int)arg1 text:(id)arg2 size:(int)arg3 inMapRect:(SCD_Struct_Se14)arg4 ;

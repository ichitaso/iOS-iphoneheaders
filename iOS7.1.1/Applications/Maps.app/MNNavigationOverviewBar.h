...
@class TopBarTitleView, UIBarButtonItem, MainChromeViewController, NSString;
...
@property (assign,nonatomic,__weak) <MNNavigationOverviewBarDelegate> * delegate;              //@synthesize delegate=_delegate - In the implementation block

...
@interface MNRoute : VKAttributedRoute {
	...
	SCD_Struct_Si13 _preferredCoordinate;
...
@property (nonatomic,readonly) SCD_Struct_Si13* mapPoints;                                     //@synthesize mapPoints=_mapPoints - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_Si13 startCoordinate; 
@property (nonatomic,readonly) SCD_Struct_Si13 endCoordinate; 
@property (nonatomic,readonly) SCD_Struct_Si13 midPoint; 
...
@property (assign,nonatomic) SCD_Struct_Si13 preferredCoordinate;                              //@synthesize preferredCoordinate=_preferredCoordinate - In the implementation block
...
-(id)routeSet;
-(SCD_Struct_Se14)boundingRectForStep:(id)arg1 ;
-(SCD_Struct_Si13*)mapPoints;
...
-(SCD_Struct_Si13)closestMapPointToMapPoint:(SCD_Struct_Si13)arg1 ;
-(SCD_Struct_Se14)boundingRectForStep:(id)arg1 fromPoint:(unsigned)arg2 ;
-(id)previousStep;
-(SCD_Struct_Se14)boundingRectForRoute;
...
-(id)listViewSteps;
-(SCD_Struct_Si13)_mkCoordAt:(unsigned)arg1 ;
-(void)_createSteps;
-(id)viaWaypoints;
...
-(SCD_Struct_Si13)startCoordinate;
-(SCD_Struct_Si13)endCoordinate;
-(SCD_Struct_Si13)midPoint;
-(double*)distancesFromStart;
-(double*)distancesFromEnd;
-(id)highlightedStep;
-(void)setHighlightedStep:(id)arg1 ;
-(SCD_Struct_Si13)preferredCoordinate;
-(void)setPreferredCoordinate:(SCD_Struct_Si13)arg1 ;

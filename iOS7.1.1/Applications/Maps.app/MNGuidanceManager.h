...
@interface MNGuidanceManager : NSObject {
	...
	SCD_Struct_MN19 _currentInstructionOptions;

}

@property (assign,nonatomic,__weak) <MNGuidanceManagerDelegate> * delegate;              //@synthesize delegate=_delegate - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_MN19 currentInstructionOptions;                  //@synthesize currentInstructionOptions=_currentInstructionOptions - In the implementation block
...
-(SCD_Struct_Si13)maneuverStepCoordinate;
-(double)_adjustedDistanceToRoute:(id)arg1 ;
-(id)_getClosestStepWithNameForProceedToRoute:(SCD_Struct_Si13)arg1 routeMatch:(id)arg2 ;
...
-(int)_currentAnnouncementStage;
-(void)updateGuidanceForProceedToRouteAtLocation:(SCD_Struct_Si13)arg1 routeMatch:(id)arg2 remainingTime:(double)arg3 distanceUntilDestination:(double)arg4 ;
...
-(BOOL)_setInstructionContentForStep:(id)arg1 withSecondary:(id)arg2 optionsToSet:(SCD_Struct_MN19*)arg3 basedOnPortion:(double)arg4 ;
-(double)_getPortionForStep:(id)arg1 withSecondary:(id)arg2 basedOnOptions:(SCD_Struct_MN19*)arg3 ;
...
-(SCD_Struct_MN19)currentInstructionOptions;
-(void)setCurrentInstructionOptions:(SCD_Struct_MN19)arg1 ;
-(id)route;
-(void)dealloc;

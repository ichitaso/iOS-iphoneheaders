...
-(BOOL)getBlockSetWithImage:(CGImageRef)arg1 into:(SCD_Struct_CI19*)arg2 width:(unsigned long long)arg3 height:(unsigned long long)arg4 ;
-(BOOL)getDataProviderBytePtrWithImage:(CGImageRef)arg1 into:(SCD_Struct_CI19*)arg2 width:(unsigned long long)arg3 height:(unsigned long long)arg4 ;
-(BOOL)getDataProviderCopyWithImage:(CGImageRef)arg1 into:(SCD_Struct_CI19*)arg2 ;
...
-(BOOL)extractReusableAlignedBitmapsAroundPoint:(SCD_Struct_CI19*)arg1 YR:(GridROI_t)arg2 subYBitmap:(SCD_Struct_CI19*)arg3 subCbCrBitmap:(SCD_Struct_CI19*)arg4 ;
-(int)averageValueFromY:(SCD_Struct_CI19*)arg1 withinSkinMask:(SCD_Struct_CI19*)arg2 butOutsideAlpha:(SCD_Struct_CI19*)arg3 ;
-(BOOL)computeTrimmedBitmaps:(SCD_Struct_CI19*)arg1 newY:(SCD_Struct_CI19*)arg2 newCbCr:(SCD_Struct_CI19*)arg3 IR:(GridROI_t)arg4 newTrimY:(SCD_Struct_CI19*)arg5 newTrimCbCr:(SCD_Struct_CI19*)arg6 returningYR:(GridROI_t*)arg7 andCbCrR:(GridROI_t*)arg8 ;
...
-(BOOL)gatherProminencesWithC:(SCD_Struct_CI19*)arg1 MC:(SCD_Struct_CI19*)arg2 altC:(SCD_Struct_CI19*)arg3 altMC:(SCD_Struct_CI19*)arg4 maxwindowsize:(int)arg5 repairsize:(int)arg6 IR:(GridROI_t)arg7 fr:(SCD_Struct_CI29*)arg8 intoHopper:(SCD_Struct_CI28*)arg9 faceIndex:(int)arg10 left:(BOOL)arg11 ;
...
-(void)autoRepairExtractAndSearchLeft:(GridROI_t)arg1 right:(GridROI_t)arg2 data:(SCD_Struct_CI29*)arg3 repairSize:(float)arg4 autoPupilTonality:(BOOL)arg5 faceIndex:(int)arg6 ;

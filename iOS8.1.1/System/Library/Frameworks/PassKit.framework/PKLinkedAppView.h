...
@class NSArray, NSDictionary, SSSoftwareLibraryItem, UIImageView, UILabel, UIButton, PKLinkedAppUserRatingView, UIActivityIndicatorView, SKStoreProductViewController, NSURL, NSString;

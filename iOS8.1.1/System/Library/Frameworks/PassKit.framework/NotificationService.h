...
+(id)_predicateForServiceType:(long long)arg1 ;
+(id)_notificationServicesInDatabase:(id)arg1 matchingPredicate:(id)arg2 ;
+(id)_propertySettersForPaymentTransaction;
+(id)insertNotificationServiceWithPushTopic:(id)arg1 serviceType:(long long)arg2 serviceURL:(id)arg3 deviceIdentifier:(id)arg4 inDatabase:(id)arg5 ;
+(id)anyInDatabase:(id)arg1 withPushTopic:(id)arg2 ;
+(id)anyInDatabase:(id)arg1 withServiceURL:(id)arg2 ;
+(id)anyInDatabase:(id)arg1 withPushTopic:(id)arg2 serviceType:(long long)arg3 serviceURL:(id)arg4 ;
+(id)notificationServicesInDatabase:(id)arg1 ;
+(id)notificationServicesInDatabase:(id)arg1 withPushTopic:(id)arg2 ;
+(id)notificationServicesInDatabase:(id)arg1 withPushTopic:(id)arg2 serviceType:(long long)arg3 serviceURL:(id)arg4 ;
+(id)_predicateForNotificationServicePID:(id)arg1 ;
+(id)associationPropertyForEntityClass:(Class)arg1 ;
+(id)databaseTable;
-(id)notificationService;
-(void)updateWithNotificationService:(id)arg1 ;
-(id)initWithPushTopic:(id)arg1 serviceType:(long long)arg2 serviceURL:(id)arg3 deviceIdentifier:(id)arg4 inDatabase:(id)arg5 ;

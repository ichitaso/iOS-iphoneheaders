...
@property (assign) BOOL _prohibitAuthUI;                                              //@synthesize _prohibitAuthUI=__prohibitAuthUI - In the implementation block
@property (assign) BOOL _strictContentLength;                                         //@synthesize _strictContentLength=__strictContentLength - In the implementation block
...
@property (setter=_setConnectionIsCellular:) BOOL _connectionIsCellular;              //@synthesize _connectionIsCellular=__connectionIsCellular - In the implementation block

...
-(BOOL)handleErrorReply:(id)arg1 fromMessageSettingKey:(CFStringRef)arg2 toValue:(void*)arg3 retryContinuation:(/*^block*/id)arg4 ;
...
-(BOOL)handleErrorReply:(id)arg1 retryContinuation:(/*^block*/id)arg2 ;

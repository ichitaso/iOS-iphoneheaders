...
@property (assign,nonatomic) SCD_Struct_EK19 flags;                                                 //@synthesize flags=_flags - In the implementation block
...
-(void)setFlags:(SCD_Struct_EK19)arg1 ;

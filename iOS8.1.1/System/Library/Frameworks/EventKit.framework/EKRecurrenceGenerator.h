...
+(id)generator;
-(id)copyOccurrenceDatesWithCalEvent:(void*)arg1 startDate:(SCD_Struct_EK12)arg2 endDate:(SCD_Struct_EK12)arg3 timeZone:(id)arg4 limit:(long long)arg5 locked:(BOOL)arg6 ;
...
-(id)copyOccurrenceDatesWithEKEvent:(id)arg1 recurrenceRule:(id)arg2 startDate:(SCD_Struct_EK12)arg3 endDate:(SCD_Struct_EK12)arg4 timeZone:(id)arg5 exceptionDates:(id)arg6 limit:(long long)arg7 ;
-(BOOL)occurrenceDate:(id)arg1 matchesRecurrenceRule:(id)arg2 forEvent:(id)arg3 includeDetachedEventsInSeries:(BOOL)arg4 ;
-(id)copyOccurrenceDatesWithEvent:(id)arg1 recurrenceRule:(id)arg2 startDate:(SCD_Struct_EK12)arg3 endDate:(SCD_Struct_EK12)arg4 timeZone:(id)arg5 limit:(long long)arg6 ;
...
-(id)_copyOccurrenceDatesBetweenStartDate:(SCD_Struct_EK12)arg1 endDate:(SCD_Struct_EK12)arg2 timeZone:(id)arg3 limit:(long long)arg4 ;
-(void)_setupForCalEvent:(void*)arg1 locked:(BOOL)arg2 ;
-(id)_copyOccurrenceDatesWithBirthdayEvent:(void*)arg1 startDate:(SCD_Struct_EK12)arg2 endDate:(SCD_Struct_EK12)arg3 timeZone:(id)arg4 limit:(long long)arg5 locked:(BOOL)arg6 ;
...
-(BOOL)_validateCalDate:(SCD_Struct_EK12)arg1 pinned:(BOOL)arg2 ;
-(id)copyOccurrenceDatesWithEKEvent:(id)arg1 startDate:(SCD_Struct_EK12)arg2 endDate:(SCD_Struct_EK12)arg3 timeZone:(id)arg4 limit:(long long)arg5 ;
-(id)copyOccurrenceDatesWithEKEvent:(id)arg1 recurrenceRule:(id)arg2 startDate:(SCD_Struct_EK12)arg3 endDate:(SCD_Struct_EK12)arg4 timeZone:(id)arg5 limit:(long long)arg6 ;
-(id)copyOccurrenceDatesWithEvent:(id)arg1 startDate:(SCD_Struct_EK12)arg2 endDate:(SCD_Struct_EK12)arg3 timeZone:(id)arg4 limit:(long long)arg5 ;

...
-(BOOL)writeBorderedThumbnailOfImage:(CGImageRef)arg1 toBuffer:(void*)arg2 orientation:(int*)arg3 format:(int)arg4 formatInfo:(const SCD_Struct_PL12*)arg5 delegate:(id)arg6 ;
-(id)_thumbnailData;
-(id)serializedData;

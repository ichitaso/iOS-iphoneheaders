...
@class NSMutableArray, ACDDatabase, ACDClientAuthorizationManager, ACDFakeRemoteAccountStoreSession, ACDClient, ACDAccountStoreFilter, ACDAuthenticationPluginManager, ACDAccessPluginManager, ACDDataclassOwnersManager, ACDAuthenticationDialogManager, ACRemoteDeviceProxy, NSString;

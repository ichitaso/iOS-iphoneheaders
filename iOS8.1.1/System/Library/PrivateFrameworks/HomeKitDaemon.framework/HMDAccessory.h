...
@property (assign,nonatomic) BOOL isAccessoryPaired;                                          //@synthesize isAccessoryPaired=_isAccessoryPaired - In the implementation block
...
@property (assign,nonatomic) BOOL remoteAccessState;                                          //@synthesize remoteAccessState=_remoteAccessState - In the implementation block
@property (assign,nonatomic) BOOL isAccessoryReachable;                                       //@synthesize isAccessoryReachable=_isAccessoryReachable - In the implementation block
...
-(void)configureWithAccessory:(id)arg1 forRemoval:(BOOL)arg2 queue:(id)arg3 completion:(/*^block*/id)arg4 ;

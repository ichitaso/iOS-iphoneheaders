...
-(void)keybagUUID:(id*)arg1 keybagID:(long long*)arg2 forBackupUDID:(id)arg3 ;
...
-(id)fileChangeEnumeratorWithOffset:(unsigned long long)arg1 limit:(unsigned long long)arg2 ;

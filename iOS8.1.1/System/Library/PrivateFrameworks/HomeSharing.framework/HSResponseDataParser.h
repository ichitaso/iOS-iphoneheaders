...
+(unsigned long long)parseItemWithBytes:(const char*)arg1 length:(unsigned long long)arg2 valuesOut:(SCD_Struct_HS4*)arg3 valuesCapacity:(unsigned long long)arg4 ;

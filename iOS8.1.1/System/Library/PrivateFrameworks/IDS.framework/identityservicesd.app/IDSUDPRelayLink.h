...
-(void)sendCommNATRequestWithPacketBuffer:(SCD_Struct_ID7*)arg1 startTime:(double)arg2 scheduledRexmit:(int)arg3 ;
...
-(void)sendRelayRequestWithType:(long long)arg1 packetBuffer:(SCD_Struct_ID7*)arg2 startTime:(double)arg3 scheduledRexmit:(int)arg4 sendItNow:(BOOL)arg5 ;
...
-(void)processCommNATPacket:(SCD_Struct_ID7*)arg1 ;
-(BOOL)processStunPacket:(SCD_Struct_ID7*)arg1 ;

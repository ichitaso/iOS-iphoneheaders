...
@protocol IDSBTLinkManagerDelegate;
@class CBCentralManager, CBPeripheralManager, CBScalablePipeManager, CBPeripheral, NSMutableArray, NSString, NSMutableDictionary;

...
-(void)setMaximumRecentsAgeInDays:(unsigned long long)arg1 forRecentsDomain:(id)arg2 ;
...
-(id)copyContactRecentsFromStatement:(sqlite3_stmtRef)arg1 selectIndexes:(SCD_Struct_CR4)arg2 groupThreshold:(unsigned long long)arg3 options:(unsigned long long)arg4 ;
...
-(unsigned long long)_databasePropertyValueByKey:(id)arg1 ;
-(unsigned long long)_propertyValueForKey:(id)arg1 defaultValue:(unsigned long long)arg2 ;
-(void)_setPropertyValue:(unsigned long long)arg1 forKey:(id)arg2 ;
...
-(unsigned long long)maximumRecentsForDomain:(id)arg1 ;
-(unsigned long long)maximumGroupRecentsForDomain:(id)arg1 ;
-(unsigned long long)maximumRecentsAgeInDaysForDomain:(id)arg1 ;
-(id)_nts_expungeRecentsOlderThanDate:(id)arg1 domain:(id)arg2 storeKeys:(id*)arg3 connection:(id)arg4 ;
-(id)_nts_expungeGroupRecentsOverLimit:(unsigned long long)arg1 domain:(id)arg2 storeKeys:(id*)arg3 connection:(id)arg4 ;
-(id)_nts_expungeIndividualRecentsOverLimit:(unsigned long long)arg1 domain:(id)arg2 storeKeys:(id*)arg3 connection:(id)arg4 ;
...
-(void)setMaximumRecents:(unsigned long long)arg1 forRecentsDomain:(id)arg2 ;
...
-(void)setMaximumGroupRecents:(unsigned long long)arg1 forRecentsDomain:(id)arg2 ;
-(unsigned long long)recordContactEvents:(id)arg1 recentsDomain:(id)arg2 sendingAddress:(id)arg3 source:(id)arg4 ;
...
-(BOOL)_setDatabasePropertyValue:(unsigned long long)arg1 forKey:(id)arg2 ;

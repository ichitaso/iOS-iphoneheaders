...
@property (nonatomic,retain) NSNumber * lastEditorDeviceKey;               //@synthesize lastEditorDeviceKey=_lastEditorDeviceKey - In the implementation block
...
-(NSNumber *)lastEditorDeviceKey;
-(void)setLastEditorDeviceKey:(NSNumber *)arg1 ;

...
@interface CUIShapeEffectStack : NSObject {
	...
	SCD_Struct_CU28 colorOverlay;
	BOOL hasInnerGradient;
	SCD_Struct_CU29 innerGradient;
	BOOL hasInnerGlow;
	SCD_Struct_CU30 innerGlow;
	BOOL hasInnerShadow;
	SCD_Struct_CU31 insideShadow;
	BOOL hasOuterGlow;
	SCD_Struct_CU32 outerGlow;
	BOOL hasEngraveShadow;
	SCD_Struct_CU33 engraveShadow;
	BOOL hasExtraShadow;
	SCD_Struct_CU33 extraShadow;
	BOOL hasBevelEmboss;
	SCD_Struct_CU34 emboss;
	float scalefactor;
	int renderStrategy;
...
+(id)gradientWithParameters:(SCD_Struct_CU29*)arg1 inRect:(CGRect)arg2 ;

...
@class VKMapCanvas, VKClassicGlobeCanvas, MDDisplayLayer, NSString, VKAnimation, VKLabelMarker, VKMemoryObserver, GGLDisplayLink, NSMutableArray, CADisplay, VKStyleManager, GEOMapRegion, NSArray, VKPolylineOverlayPainter;
...
-(void)prepareFlyoverAnimation:(id)arg1 inBackground:(BOOL)arg2 completion:(/*^block*/id)arg3 ;

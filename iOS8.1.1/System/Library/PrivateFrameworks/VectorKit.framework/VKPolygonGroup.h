...
-(void)prepareForPolygon:(SCD_Struct_VK290*)arg1 building:(SCD_Struct_VK371*)arg2 hasNonWaterStyle:(BOOL)arg3 forRoofStyle:(int)arg4 scaleThreshold:(float)arg5 ;
-(void)willAddDataWithAccessor:(ResourceAccessor*)arg1 ;
-(void)addPolygon:(SCD_Struct_VK290*)arg1 building:(SCD_Struct_VK371*)arg2 index:(unsigned long long)arg3 ofTotal:(unsigned long long)arg4 hasNonWaterStyle:(BOOL)arg5 accessor:(ResourceAccessor*)arg6 triangulator:(id)arg7 prepareExtrusion:(BOOL)arg8 forRoofStyle:(int)arg9 scaleThreshold:(float)arg10 ;
-(void)didFinishAddingData;
-(unsigned char)indexForGeoFeatureAttributes:(id)arg1 ;
-(BOOL)canConstructPointyRoofForPolygon:(SCD_Struct_VK290*)arg1 building:(SCD_Struct_VK371*)arg2 buildingModel:(unsigned char)arg3 scaleThreshold:(float)arg4 ;
-(BOOL)addPointyRoofForPolygon:(SCD_Struct_VK290*)arg1 building:(SCD_Struct_VK371*)arg2 buildingModel:(unsigned char)arg3 scaleThreshold:(float)arg4 styleIndex:(float)arg5 ;
-(void)addExtrusionForPolygon:(SCD_Struct_VK290*)arg1 building:(SCD_Struct_VK371*)arg2 index:(unsigned long long)arg3 ofTotal:(unsigned long long)arg4 hasNonWaterStyle:(BOOL)arg5 triangulator:(id)arg6 forRoofStyle:(int)arg7 ;

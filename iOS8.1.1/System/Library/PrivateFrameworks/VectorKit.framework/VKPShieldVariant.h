...
@interface VKPShieldVariant : PBCodable <NSCopying> {
	...
	SCD_Struct_VK381 _textShadow;
	SCD_Struct_VK383* _layers;
	unsigned long long _layersCount;
	unsigned long long _layersSpace;
	SCD_Struct_VK384 _textStroke;
	SCD_Struct_VK379 _fontColor;
...
@property (assign,nonatomic) SCD_Struct_VK379 fontColor;                          //@synthesize fontColor=_fontColor - In the implementation block
@property (assign,nonatomic) BOOL hasTextStroke; 
@property (assign,nonatomic) SCD_Struct_VK386 textStroke;                         //@synthesize textStroke=_textStroke - In the implementation block
@property (assign,nonatomic) BOOL hasTextShadow; 
@property (assign,nonatomic) SCD_Struct_VK387 textShadow;                         //@synthesize textShadow=_textShadow - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_VK383* layers; 
...
-(CGImageRef)newImageWithTextureAtlases:(id)arg1 atlasToImageCache:(id)arg2 contentScale:(double)arg3 colors:(SCD_Struct_VK81*)arg4 ;
-(void)dealloc;
...
-(BOOL)hasTextStroke;
-(SCD_Struct_VK386)textStroke;
-(BOOL)hasTextShadow;
-(SCD_Struct_VK387)textShadow;
-(BOOL)hasTextMaskColor;
-(int)textMaskColor;
-(BOOL)hasFontColor;
-(SCD_Struct_VK379)fontColor;
-(BOOL)hasFontName;
...
-(unsigned)atlasIndex;
-(unsigned)quadIndex;
-(SCD_Struct_VK383)layerAtIndex:(unsigned long long)arg1 ;
...
-(void)addLayer:(SCD_Struct_VK383)arg1 ;
...
-(BOOL)hasFontSize;
-(void)setFontColor:(SCD_Struct_VK379)arg1 ;
-(void)setHasFontColor:(BOOL)arg1 ;
-(void)setTextStroke:(SCD_Struct_VK386)arg1 ;
-(void)setHasTextStroke:(BOOL)arg1 ;
-(void)setTextShadow:(SCD_Struct_VK387)arg1 ;
...
-(SCD_Struct_VK383*)layers;
-(void)setLayers:(SCD_Struct_VK383*)arg1 count:(unsigned long long)arg2 ;

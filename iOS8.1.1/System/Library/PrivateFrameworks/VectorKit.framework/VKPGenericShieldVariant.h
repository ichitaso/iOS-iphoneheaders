...
@property (nonatomic,readonly) SCD_Struct_VK608* layers; 
...
-(SCD_Struct_VK608)layerAtIndex:(unsigned long long)arg1 ;
-(void)clearLayers;
-(void)addLayer:(SCD_Struct_VK608)arg1 ;
-(void)setTextBaseline:(float)arg1 ;
-(void)setHasTextBaseline:(BOOL)arg1 ;
-(BOOL)hasTextBaseline;
-(void)setHasFontSize:(BOOL)arg1 ;
-(BOOL)hasFontSize;
-(SCD_Struct_VK608*)layers;
-(void)setLayers:(SCD_Struct_VK608*)arg1 count:(unsigned long long)arg2 ;
-(float)rightCapWidth;
-(float)leftPadding;

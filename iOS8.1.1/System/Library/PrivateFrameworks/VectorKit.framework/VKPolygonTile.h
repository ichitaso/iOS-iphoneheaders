...
-(void)buildMeshesWithStyleSession:(StyleResolutionSession*)arg1 device:(Device*)arg2 triangulator:(id)arg3 prepareExtrusion:(BOOL)arg4 ;
-(void)buildCoastlinesWithStyleSession:(StyleResolutionSession*)arg1 ;

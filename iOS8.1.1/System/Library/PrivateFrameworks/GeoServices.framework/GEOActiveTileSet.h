...
-(unsigned)maximumZoomLevelInRect:(SCD_Struct_GE51)arg1 ;
-(BOOL)isEquivalentTileSet:(id)arg1 ;
-(id)dataForGenericTileType:(int)arg1 tileGroupIdentifier:(unsigned)arg2 ;
-(unsigned)minimumZoomLevelInRect:(SCD_Struct_GE51)arg1 ;
-(unsigned)largestZoomLevelLEQ:(unsigned)arg1 inRect:(SCD_Struct_GE51)arg2 ;
-(void)dealloc;
-(int)size;

...
@interface GEOSuggestionEntry : PBCodable <NSCopying> {
	...
	SCD_Struct_GE189* _textHighlights;
...
@property (nonatomic,readonly) SCD_Struct_GE189* textHighlights; 
...
-(SCD_Struct_GE189*)textHighlights;
...
-(SCD_Struct_GE189)textHighlightsAtIndex:(unsigned long long)arg1 ;
-(void)addTextHighlights:(SCD_Struct_GE189)arg1 ;
-(void)setTextHighlights:(SCD_Struct_GE189*)arg1 count:(unsigned long long)arg2 ;
-(BOOL)hasIconID;
-(NSString *)iconID;

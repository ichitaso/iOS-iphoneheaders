...
@property (nonatomic,readonly) SCD_Struct_GE71* availableTiles; 
...
@property (nonatomic,readonly) SCD_Struct_GE72* genericTiles; 
...
-(SCD_Struct_GE71)availableTilesAtIndex:(unsigned long long)arg1 ;
-(void)addAvailableTiles:(SCD_Struct_GE71)arg1 ;
-(unsigned long long)genericTilesCount;
-(SCD_Struct_GE72)genericTileAtIndex:(unsigned long long)arg1 ;
-(void)addGenericTile:(SCD_Struct_GE72)arg1 ;
-(SCD_Struct_GE71*)availableTiles;
-(void)setAvailableTiles:(SCD_Struct_GE71*)arg1 count:(unsigned long long)arg2 ;
-(void)setTimeToLiveSeconds:(unsigned)arg1 ;
-(void)setHasTimeToLiveSeconds:(BOOL)arg1 ;
-(BOOL)hasTimeToLiveSeconds;
-(SCD_Struct_GE72*)genericTiles;
-(void)setGenericTiles:(SCD_Struct_GE72*)arg1 count:(unsigned long long)arg2 ;

...
-(id)errorHandler;
-(void)providerReceivedError:(id)arg1 problemDetails:(SCD_Struct_GE56*)arg2 ;
-(void)providerReceivedErrorCode:(long long)arg1 userInfo:(id)arg2 problemDetails:(SCD_Struct_GE56*)arg3 ;

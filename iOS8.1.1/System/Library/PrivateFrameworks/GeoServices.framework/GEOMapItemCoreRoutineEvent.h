...
-(NSString *)eventName;
-(BOOL)isEventAllDay;
-(id)initWithAddressDictionary:(id)arg1 eventName:(id)arg2 eventTitle:(id)arg3 eventDate:(id)arg4 eventIsAllDay:(BOOL)arg5 coordinate:(SCD_Struct_GE14)arg6 clientAttributes:(id)arg7 ;

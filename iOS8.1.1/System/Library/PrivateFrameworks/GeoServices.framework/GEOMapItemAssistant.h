...
@class GEOLocation, NSDictionary, NSString, NSURL, GEOPlace, NSData, GEOMapRegion, GEOAddress, NSArray, NSDate, GEOPDPlace, GEOMapItemClientAttributes, GEOPDFlyover, GEOMapItemPlaceAttribution, GEOMapItemPhotosAttribution, GEOMapItemReviewsAttribution, GEOFeatureStyleAttributes;

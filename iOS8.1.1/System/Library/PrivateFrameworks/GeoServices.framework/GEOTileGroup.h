...
@interface GEOTileGroup : PBCodable <NSCopying> {
	...
	SCD_Struct_GE65* _regionalResourceIndexs;
	unsigned long long _regionalResourceIndexsCount;
	unsigned long long _regionalResourceIndexsSpace;
	SCD_Struct_GE53* _attributionIndexs;
	SCD_Struct_GE53* _fontIndexs;
	SCD_Struct_GE53* _iconIndexs;
	SCD_Struct_GE53* _styleSheetIndexs;
	SCD_Struct_GE53* _textureIndexs;
	SCD_Struct_GE53* _xmlIndexs;
	SCD_Struct_GE83* _tileSets;
...
@property (nonatomic,readonly) SCD_Struct_GE83* tileSets; 
...
@property (nonatomic,readonly) SCD_Struct_GE65* regionalResourceIndexs; 
...
-(void)addTileSet:(SCD_Struct_GE83)arg1 ;
-(unsigned long long)tileSetsCount;
-(void)clearTileSets;
-(SCD_Struct_GE83)tileSetAtIndex:(unsigned long long)arg1 ;
-(SCD_Struct_GE83*)tileSets;
...
-(SCD_Struct_GE65)regionalResourceIndexAtIndex:(unsigned long long)arg1 ;
-(void)addRegionalResourceIndex:(SCD_Struct_GE65)arg1 ;
...
-(void)setTileSets:(SCD_Struct_GE83*)arg1 count:(unsigned long long)arg2 ;
...
-(SCD_Struct_GE65*)regionalResourceIndexs;
-(void)setRegionalResourceIndexs:(SCD_Struct_GE65*)arg1 count:(unsigned long long)arg2 ;
-(unsigned*)xmlIndexs;

...
@class NSMutableDictionary, NSSet, BBDataProviderManager, NSMutableSet, NSMutableArray, NSArray, NSDate, NSObject, NSString, BBSyncService, NSXPCListener, BBApplicationLauncher, ABFavoritesListManager;

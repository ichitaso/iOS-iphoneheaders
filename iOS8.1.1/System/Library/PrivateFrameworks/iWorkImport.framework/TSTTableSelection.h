...
@interface TSTTableSelection : TSKSelection <NSCopying, TSDTextSelection> {
	...
	int mSelectionType;
	SCD_Struct_TS272 mAnchorCellID;
	TSTCellRegion* mCellRegion;
	TSTCellRegion* mBaseRegion;
	SCD_Struct_TS272 mCursorCellID;
...
@property (nonatomic,readonly) SCD_Struct_TS272 anchorCellID; 
@property (nonatomic,readonly) TSTCellRegion * baseRegion; 
@property (nonatomic,readonly) SCD_Struct_TS272 cursorCellID; 
...
-(id)initWithTableModel:(id)arg1 cellRegion:(id)arg2 anchorCellID:(SCD_Struct_TS272)arg3 cursorCellID:(SCD_Struct_TS272)arg4 baseRegion:(id)arg5 selectionType:(int)arg6 ;
-(id)initWithTableModel:(id)arg1 cellRegion:(id)arg2 anchorCellID:(SCD_Struct_TS272)arg3 cursorCellID:(SCD_Struct_TS272)arg4 baseRegion:(id)arg5 ;
-(id)initWithTableModel:(id)arg1 cellRegion:(id)arg2 anchorCellID:(SCD_Struct_TS272)arg3 cursorCellID:(SCD_Struct_TS272)arg4 selectionType:(int)arg5 ;
-(id)initWithTableModel:(id)arg1 cellRange:(SCD_Struct_TS488)arg2 type:(int)arg3 anchorCellID:(SCD_Struct_TS272)arg4 cursorCellID:(SCD_Struct_TS272)arg5 ;
...
-(SCD_Struct_TS272)anchorCellID;
-(SCD_Struct_TS272)cursorCellID;
...
-(id)selectionByExtendingWithCellRange:(SCD_Struct_TS488)arg1 inTable:(id)arg2 selectionType:(int)arg3 cursorCell:(SCD_Struct_TS272)arg4 ;
-(id)initWithTableModel:(id)arg1 andCellID:(SCD_Struct_TS272)arg2 ;
-(void)enumerateSelectedCellsInTable:(id)arg1 withFlags:(unsigned long long)arg2 usingBlock:(/*^block*/id)arg3 ;
-(BOOL)isAtEndOfLine;
-(id)initWithTableModel:(id)arg1 cellRegion:(id)arg2 anchorCellID:(SCD_Struct_TS272)arg3 cursorCellID:(SCD_Struct_TS272)arg4 ;
-(id)initWithTableModel:(id)arg1 selectionType:(int)arg2 ;
-(id)initWithTableModel:(id)arg1 andCellRange:(SCD_Struct_TS488)arg2 ;
-(id)initWithTableModel:(id)arg1 cellID:(SCD_Struct_TS272)arg2 selectionType:(int)arg3 ;
-(id)initWithTableModel:(id)arg1 rowOrColumn:(int)arg2 index:(unsigned)arg3 count:(unsigned)arg4 ;
-(id)initWithTableModel:(id)arg1 andPreviousSelection:(id)arg2 offsetBy:(SCD_Struct_TS479)arg3 ;
-(id)initWithTableModel:(id)arg1 cellRegion:(id)arg2 ;
-(id)selectionByAddingCellRange:(SCD_Struct_TS488)arg1 inTable:(id)arg2 withAnchor:(SCD_Struct_TS272)arg3 cursor:(SCD_Struct_TS272)arg4 selectionType:(int)arg5 ;
-(id)selectionByRemovingCellRange:(SCD_Struct_TS488)arg1 inTable:(id)arg2 withAnchor:(SCD_Struct_TS272)arg3 cursor:(SCD_Struct_TS272)arg4 selectionType:(int)arg5 ;

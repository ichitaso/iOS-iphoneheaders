...
-(BOOL)p_tableHasRange:(SCD_Struct_TS276*)arg1 withCalcEngine:(id)arg2 ;
...
-(id)expandSingleRangeForProposedCategoryLabels:(SCD_Struct_TS276*)arg1 ;
-(BOOL)p_tableHasCell:(SCD_Struct_TS282*)arg1 withCalcEngine:(id)arg2 ;

...
-(BOOL)isSage;
-(id)initWithScene:(id)arg1 containingViewport:(const tvec2<int>*)arg2 originalContainingViewport:(const tvec2<int>*)arg3 layoutSettings:(const SCD_Struct_TS399*)arg4 ;

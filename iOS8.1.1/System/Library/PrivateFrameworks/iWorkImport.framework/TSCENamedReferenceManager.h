...
-(BOOL)referenceNameIsUnique:(id)arg1 forReference:(SCD_Struct_TS276*)arg2 contextTable:(CFUUIDRef)arg3 ;
...
-(SCD_Struct_TS276*)rangeForTrackedReference:(id)arg1 gettingTrackedCell:(SCD_Struct_TS282*)arg2 ;
-(id)referenceTracker;
-(void)setCalculationEngine:(id)arg1 ;
-(void)beginTrackingNamesInRange:(SCD_Struct_TS275)arg1 ofResolver:(id)arg2 addingTrackedReferencesTo:(id)arg3 ;
-(void)beginTrackingNameInCell:(SCD_Struct_TS272)arg1 ofResolver:(id)arg2 addingTrackedReferencesTo:(id)arg3 ;
...
-(id)beginTrackingNamesInTable:(CFUUIDRef)arg1 limitedToRange:(SCD_Struct_TS275)arg2 ;

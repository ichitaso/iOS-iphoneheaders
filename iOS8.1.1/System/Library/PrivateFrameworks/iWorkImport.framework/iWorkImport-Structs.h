...
typedef struct {
	SCD_Struct_TS272 mTopLeft;
	SCD_Struct_TS272 mBottomRight;
} SCD_Struct_TS275;

typedef struct {
	SCD_Struct_TS275 range;
	__CFUUID tableID;
} SCD_Struct_TS276;

typedef struct {
	__CFUUID mTableID;
	SCD_Struct_TS275 mOldTableSize;
	SCD_Struct_TS275 mNewTableSize;
} SCD_Struct_TS277;

typedef struct {
	__CFUUID mTableID;
	SCD_Struct_TS275 mMergedRange;
} SCD_Struct_TS278;

typedef struct {
	SCD_Struct_TS276 mFromReference;
	SCD_Struct_TS276 mToReference;
} SCD_Struct_TS279;

typedef union {
	TSCETectonicShift* mTectonicShift;
	SCD_Struct_TS273 mRemapSortMappingInfo;
	SCD_Struct_TS279 mRangeMovedInfo;
	__CFUUID mDeletedOwnerID;
	SCD_Struct_TS277 mTableResizedInfo;
	SCD_Struct_TS278 mCellMergedInfo;
	SCD_Struct_TS274 mTransposedInfo;
} SCD_Union_TS280;
...
typedef struct {
	...
	SCD_Struct_TS276 rangeReference;
	SCD_Struct_TS330 spanningRangeReference;
	__CFUUID) tableID;
} SCD_Struct_TS331;
...
typedef struct {
	SCD_Struct_TS255 topLeft;
	SCD_Struct_TS255 bottomRight;
} SCD_Struct_TS477;
...
typedef struct {
	SCD_Struct_TS502 topLeft;
	SCD_Struct_TS502 bottomRight;
} SCD_Struct_TS503;
...
typedef struct {
	...
	NSDate* date;
	NSString* string;
	SCD_Struct_TS549 reference;
	SCD_Struct_TS548) duration;
} SCD_Struct_TS550;
...
typedef struct {
	...
	SCD_Struct_TS599 parData;
	SCD_Struct_TS599 parStartData;
	SCD_Struct_TS599 parBidiData;
} SCD_Struct_TS600;
...
typedef struct {
	...
	5 field4;
	SCD_Struct_TS47 field5;
	5 field6;
	SCD_Struct_TS47 field7;
	1 field8;
} SCD_Struct_KN620;
